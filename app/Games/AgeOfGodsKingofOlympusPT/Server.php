        ...
        {/*
            ...
            if( isset($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['spinType']) ) 
            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['spinType'] == 'regular' ) 
                {
                    ...
                    $bonusMpl = 1;
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTBonusWin', 0);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTFreeGames', 0);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTCurrentFreeGame', 0);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTTotalWin', 0);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTFreeBalance', 0);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTFreeStartWin', 0);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTFreeMpl', $slotSettings->slotFreeMpl);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTIncreaseMpl', 0);
                }
                else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['spinType'] == 'free' ) 
                {
                    ...
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTCurrentFreeGame', $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTCurrentFreeGame') + 1);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTIncreaseMpl', $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTIncreaseMpl') + 1);
                    ...
                    $bonusMpl = $_obf_0D32121F062C192C3B232E0A33102329195B1E055C1B22[$slotSettings->GetGameData('AgeOfGodsKingofOlympusPTIncreaseMpl')];
                }
                $linesId = [];
                $linesId[0] = [
                    2, 
                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                    {
                                        ...
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[4], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTBonusWin', $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTBonusWin') + $totalWin);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTTotalWin', $totalWin);
                }
                else
                {
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTTotalWin', $totalWin);
                }
                $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTBonusStart', false);
                if( $scattersCount >= 3 ) 
                {
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTBonusStart', true);
                    $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTBonusStep', 0);
                    if( $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTFreeGames') > 0 ) 
                    {
                        $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTFreeGames', $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTFreeGames') + 15);
                    }
                    else
                    {
                        $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTIncreaseMpl', 0);
                        $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTFreeStartWin', $totalWin);
                        $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTBonusWin', 0);
                        $slotSettings->SetGameData('AgeOfGodsKingofOlympusPTFreeGames', $slotSettings->slotFreeCount);
                    }
                }
                $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D0C0B3E1D3D2119330A2611285C3E062E112A2F241222 = 'REGULAR';
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['spinType'] == 'free' ) 
                {
                    $_obf_0D0C0B3E1D3D2119330A2611285C3E062E112A2F241222 = 'FREE';
                }
                $_obf_0D352204063B1425241010342A0D112E0C153D01383132 = 'false';
                if( $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTBonusStart') ) 
                {
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"IncreaseMpl":' . $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTIncreaseMpl') . ',"linesArr":[' . implode(',', $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('AgeOfGodsKingofOlympusPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                ...
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"credit":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"results":[' . implode(',', $reels['rp']) . '],"windowId":"Adbmao"},"ID":40022,"umid":59}';
            ...
            switch( $umid ) 
            {
                ...
                case '40066':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"zeus","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . ']},"ID":40025,"umid":21}';
                    break;
                case '40036':
