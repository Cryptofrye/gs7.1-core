...
! function(Pluck) {
    var NotificationMap = function() {
        ...
        NotificationMap.prototype.register = function(controller) {
            ...
            for (var i = 0; i < interests.length; i++) this.registerRecipient(interests[i], controller)
        };
        ...
        NotificationMap.prototype.notify = function(notification) {
            ...
            if (recipients) {
                ...
                for (var i = 0; i < recipients.length; i++)
                    if (recipients[i].shouldReceiveNotifications) recipients[i].handleNotification(notification)
            }
        };
...
! function(Pluck) {
    var HashMap = function() {
        ...
        HashMap.prototype.add = function(key, value) {
            ...
            } else this.valueArray[index] = value
        };
...
! function(Pluck) {
    var ViewController = function() {
        ...
        ViewController.setRoot = function(root) {
            if (this.root) throw new Error("Root controller has been already set!");
            this.root = root;
        ...
        ViewController.disposeRootController = function() {
            ...
            while (this.root.children.length > 0) this.root.removeChildViewController(this.root.children[0]);
        ...
        ViewController.prototype.addChildViewController = function(controller) {
            if (!this.hasChildViewController(controller)) {
                ...
                if (this._view instanceof PIXI.Container && controller._view instanceof PIXI.DisplayObject) this._view.addChild(controller._view);
        ...
        ViewController.prototype.removeChildViewController = function(controller) {
            if (this.hasChildViewController(controller)) {
                while (controller.children.length > 0) controller.removeChildViewController(controller.children[0]);
        ...
        ViewController.prototype.destroy = function() {
            if (this._view instanceof PIXI.DisplayObject && this._view.parent && ViewController.shouldRemoveView) this._view.parent.removeChild(this._view);
            this.dispose();
            if (this._view && "dispose" in this._view) this._view.dispose();
            if (this._model && "dispose" in this._model) this._model.dispose();
            this._view = null;
            this._model = null
        };
        ViewController.prototype.dispose = function() {};
        ViewController.prototype.getController = function(constructor) {
            if (void 0 == ViewController.controllerMap.getVal(constructor)) return null;
        ...
        Object.defineProperty(ViewController.prototype, "zIndex", {
            get: function() {
                if (this._view instanceof PIXI.DisplayObject) {
                    ...
                    if (displayObject.parent) return displayObject.parent.getChildIndex(displayObject);
                    else return -1
                }
                return -1
            },
            set: function(value) {
                if (this._view instanceof PIXI.DisplayObject) {
                    var displayObject = this._view;
                    if (displayObject.parent) displayObject.parent.setChildIndex(displayObject, value)
                }
            },
            enumerable: true,
            configurable: true
        ...
        ViewController.shouldRemoveView = true;
    ...
    var ArrayTools = function() {
        ...
        ArrayTools.flatten = function(array) {
            ...
            for (var i = 0; i < array.length; i++) {
                var obj = array[i];
                if (obj instanceof Array) flattened = flattened.concat(this.flatten(obj));
        ...
        ArrayTools.diff = function(array, compare) {
            var unique = [];
            for (var i = 0; i < array.length; i++)
                if (array.indexOf(compare) > -1) unique.push(array[i]);
            return unique
        };
        return ArrayTools
    }();
        ...
        External.prototype.serialize = function(obj) {
            for (var key in obj)
                if (this.hasOwnProperty(key))
                    if ("object" === typeof this[key] && this[key] instanceof External) this[key].serialize(obj[key]);
                    else if (this[key] instanceof Array && "object" === typeof this[key][0] && this[key][0] instanceof External)
                if (0 == obj[key].length) this[key].length = 0;
                else {
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            }(DeviceOrientation = library.DeviceOrientation || (library.DeviceOrientation = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
var com;
! function(com) {
        ...
        ! function(library) {
            var Device = function() {
                ...
                Object.defineProperty(Device, "isCriOS", {
                    get: function() {
                        return null != navigator.userAgent.match(/CriOS/i)
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(Device, "isIE11", {
                    get: function() {
                        return !Device.isFirefox && "Netscape" == navigator.appName && null != navigator.userAgent.match(/Trident/i)
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(Device, "currentOrientation", {
                    get: function() {
                        if (void 0 != window.orientation)
                            if (window.orientation == -90 || 90 == window.orientation) return library.DeviceOrientation.Landscape;
                            else return library.DeviceOrientation.Portrait;
                        else {
                            var orientation = window.screen["orientation"] || window.screen["mozOrientation"] || window.screen.msOrientation;
                            if (orientation && void 0 != orientation.type)
                                if ("landscape-primary" === orientation.type || "landscape-secondary" === orientation.type) return library.DeviceOrientation.Landscape;
                                else return library.DeviceOrientation.Portrait;
                            else return library.DeviceOrientation.Landscape
                        }
                    },
                    enumerable: true,
                    configurable: true
                ...
                Device.resolveEvent = function(eventName) {
                    if ("mousedown" == eventName) eventName += " touchstart";
                    else if ("mouseup" == eventName) eventName += " touchend";
                    else if ("mouseupoutside" == eventName) eventName += " touchendoutside";
                    else if ("mousemove" == eventName) eventName += " touchmove";
                    else if ("click" == eventName) eventName += " tap";
                    return eventName
                };
                Device.isSoundSupported = function() {
                    return void 0 != Device.getAudioContext()
                };
                Device.getAudioContext = function() {
                    if (window.AudioContext) return AudioContext;
                    else return window.webkitAudioContext
                };
                return Device
            }();
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            ! function(events) {
                ...
                events.Event = Event
            }(events = library.events || (library.events = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
var com;
            ...
            ! function(events) {
                var EventDispatcher = function() {
                    ...
                    EventDispatcher.prototype.dispatchEvent = function(event, target) {
                        ...
                        if (!registeredObjects) return;
                        registeredObjects = registeredObjects.slice();
                        if (void 0 != target) event.target = target;
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            for (var j = 0; j < callbacksLen; j++) object.callbacks[j].call(object.context, event)
                        }
                    };
                    EventDispatcher.prototype.removeEventListener = function(type, callback, callbackContext) {
                        ...
                        for (var i = 0; i < len; i++) {
                            object = registeredObjects[i];
                            if (object.context != callbackContext) continue;
                            callbacksLen = object.callbacks.length;
                        ...
                        if (0 == len) delete this._listeners[type]
                    };
                    EventDispatcher.prototype.hasEventListener = function(type) {
                        return void 0 != this._listeners[type]
                    };
                    EventDispatcher.prototype.dispose = function() {
                        for (var type in this._listeners) delete this._listeners[type]
                    };
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            var loading;
            ! function(loading) {
                var EventDispatcher = com.egt.library.events.EventDispatcher;
            ...
            }(loading = library.loading || (library.loading = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
var com;
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            var loading;
            ! function(loading) {
                var LoaderEvent = com.egt.library.events.LoaderEvent;
                var BaseLoader = function(_super) {
                    ...
                    function BaseLoader(src, cacheTimestamp, prependURL, id) {
                        ...
                        _this._request = null;
                        if (void 0 == cacheTimestamp) cacheTimestamp = loading.Loader.cacheTimestamp;
                        _this._cacheTimestamp = cacheTimestamp;
                        if (void 0 == prependURL) prependURL = loading.Loader.prependURL;
                        _this._prependURL = prependURL;
                        _this.constructGetParameters();
                        if (void 0 == id) id = src;
                        _this._id = id;
                        loading.Loader.addLoader(_this);
                        _this._src = src;
                        _this.setUpRequest();
                    ...
                    BaseLoader.prototype.load = function() {
                        if (this._state == BaseLoader.STATE_LOADING) return;
                        else if (this._state == BaseLoader.STATE_LOADED) {
                            var self = this;
                            setTimeout(function() {
                                self.dispatchEvent(new LoaderEvent(LoaderEvent.PROGRESS, {
                                    progress: 1,
                                    progressChange: 0
                                }));
                                self.onLoaded()
                            ...
                            return
                        } else if (this._state == BaseLoader.STATE_ERROR || this._request.readyState == XMLHttpRequest.UNSENT) this.openRequest();
                        this._lastProgress = 0;
                        this._state = BaseLoader.STATE_LOADING;
                        if (this._request.readyState == XMLHttpRequest.OPENED) this._request.send();
                        else this._loadingRequested = true
                    };
                    ...
                    BaseLoader.prototype.dispose = function() {
                        ...
                        loading.Loader.removeLoader(this);
                    ...
                    BaseLoader.prototype.onXHRProgress = function(event) {
                        var newProgress;
                        if (event.lengthComputable) newProgress = event.loaded / event.total;
                        else newProgress = 1;
                        var data = {
                        ...
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.PROGRESS, data))
                    };
            ...
            ! function(loading) {
                ...
                var FontLoader = function(_super) {
                    ...
                    FontLoader.prototype.load = function() {
                        if (this._state == loading.BaseLoader.STATE_LOADING) return;
                        else if (this._state == loading.BaseLoader.STATE_LOADED) {
                            var self_1 = this;
                            setTimeout(function() {
                                self_1.onLoaded()
                            }, 0);
                    ...
                    FontLoader.prototype.onLoaded = function(event) {
                        this._state = loading.BaseLoader.STATE_LOADED;
                    ...
                    FontLoader.prototype.onError = function(event) {
                        this._state = loading.BaseLoader.STATE_ERROR;
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.ERROR))
                    };
                    return FontLoader
                }(loading.BaseLoader);
                loading.FontLoader = FontLoader
            }(loading = library.loading || (library.loading = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(loading) {
                ...
                var JSONLoader = function(_super) {
                    ...
                    JSONLoader.prototype.onLoaded = function(event) {
                        ...
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.COMPLETE, this._data))
                    };
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            ! function(loading) {
                ...
                loading.LayoutImporter = LayoutImporter
            }(loading = library.loading || (library.loading = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(loading) {
                ...
                var LayoutLoader = function(_super) {
                    ...
                    LayoutLoader.prototype.getTexture = function(name) {
                        var texture = void 0;
                        if (this._pixiLoader) texture = this._pixiLoader.getTexture(name);
                        if (this._videoAlternativeLoader && !texture) texture = this._videoAlternativeLoader.getTexture(name);
                        return texture
                    };
                    LayoutLoader.prototype.getTextureSequence = function(sequenceName, extension, texturesCount, sequenceDigitsCount) {
                        ...
                        if (this._pixiLoader) return this._pixiLoader.getTextureSequence(sequenceName, extension, texturesCount, sequenceDigitsCount);
                        return
                    };
                    LayoutLoader.prototype.load = function() {
                        ...
                        this._lastProgress = 0;
                        this._state = loading.BaseLoader.STATE_LOADING;
                        this._jsonLoader.load()
                    };
                    LayoutLoader.prototype.stop = function() {
                        if (this._state != loading.BaseLoader.STATE_LOADING) return;
                        this._state = loading.BaseLoader.STATE_IDLE;
                        this._jsonLoader.stop();
                        if (this._resourcesLoader) this._resourcesLoader.stop()
                    };
                    LayoutLoader.prototype.dispose = function() {
                        this._jsonLoader.removeEventListener(LoaderEvent.COMPLETE, this.onJSONLoaded, this);
                        this._jsonLoader.removeEventListener(LoaderEvent.ERROR, this.onError, this);
                        this._jsonLoader.dispose();
                        if (this._resourcesLoader) {
                            this._resourcesLoader.removeEventListener(LoaderEvent.COMPLETE, this.onResourcesLoaded, this);
                            this._resourcesLoader.removeEventListener(LoaderEvent.PROGRESS, this.onProgress, this);
                            this._resourcesLoader.removeEventListener(LoaderEvent.ERROR, this.onError, this);
                            this._resourcesLoader.dispose()
                        }
                        if (this._videoLoaders)
                            for (var i = 0; i < this._videoLoaders.length; i++) this._videoLoaders[i].removeEventListener(LoaderEvent.DECODE_ERROR, this.onVideoDecodeError, this);
                        if (this._data) this._data.mainContainer.destroy(true);
                        _super.prototype.dispose.call(this)
                    };
                    ...
                    LayoutLoader.prototype.setUpRequest = function() {
                        this._jsonLoader = new loading.JSONLoader(this._src, this._cacheTimestamp, this._prependURL, "layoutJSONLoader_" + this._id);
                        this._jsonLoader.addEventListener(LoaderEvent.COMPLETE, this.onJSONLoaded, this);
                        this._jsonLoader.addEventListener(LoaderEvent.ERROR, this.onError, this)
                    };
                    LayoutLoader.prototype.parseLayout = function() {
                        var importer = new loading.LayoutImporter;
                        this._data = importer["import"](this._jsonLoader.getData().jsonContent, loading.Loader.getLoader("layoutPIXILoader" + this._id))
                    };
                    LayoutLoader.prototype.onJSONLoaded = function(event) {
                        ...
                        if (0 == resources.length && 0 == fontStyles.length && 0 == bitmapFonts.length && 0 == videos.length) {
                            this.parseLayout();
                            this.onLoaded();
                            return
                        }
                        this._resourcesLoader = new loading.LoadingQueue;
                        var length = fontStyles.length;
                        for (var i = 0; i < length; i++) this._resourcesLoader.addLoader(new loading.FontLoader(fontNames[i], fontStyles[i]));
                        if (0 != resources.length || 0 != bitmapFonts.length) {
                            var lastSlashIndex = this._src.lastIndexOf("/");
                            var prependURL = this._src.substring(0, lastSlashIndex);
                            this._pixiLoader = new loading.PIXILoader(this._cacheTimestamp, prependURL, "layoutPIXILoader" + this._id);
                        ...
                        if (0 != videos.length) {
                            ...
                            for (var i = 0; i < length; i++) {
                                ...
                                var videoLoader = new loading.VideoLoader(videos[i], this._cacheTimestamp, prependURL);
                                videoLoader.addEventListener(LoaderEvent.DECODE_ERROR, this.onVideoDecodeError, this);
                                this._videoLoaders.push(videoLoader);
                                this._resourcesLoader.addLoader(videoLoader)
                            }
                        }
                        length = resources.length;
                        for (var i = 0; i < length; i++) this._pixiLoader.addResource(resources[i], "images/" + resources[i]);
                        length = bitmapFonts.length;
                        for (var i = 0; i < length; i++) this._pixiLoader.addResource(bitmapFonts[i], "images/" + bitmapFonts[i] + ".fnt");
                        this._resourcesLoader.addEventListener(LoaderEvent.COMPLETE, this.onResourcesLoaded, this);
                        this._resourcesLoader.addEventListener(LoaderEvent.PROGRESS, this.onProgress, this);
                        this._resourcesLoader.addEventListener(LoaderEvent.ERROR, this.onError, this);
                    ...
                    LayoutLoader.prototype.onLoaded = function() {
                        ...
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.PROGRESS, {
                            progress: 1,
                            progressChange: 1 - this._lastProgress
                        }));
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.COMPLETE))
                    };
                    ...
                    LayoutLoader.prototype.onVideoDecodeError = function() {
                        ...
                        for (var i = 0; i < this._videoLoaders.length; i++) {
                            ...
                            loader.removeEventListener(LoaderEvent.DECODE_ERROR, this.onVideoDecodeError, this);
                            loader.dispose()
                        }
                        this._videoLoaders.length = 0;
                        if (videoAlternative && 0 != videoAlternative.length) {
                            var lastSlashIndex = this._src.lastIndexOf("/");
                            var prependURL = this._src.substring(0, lastSlashIndex);
                            this._videoAlternativeLoader = new loading.PIXILoader(this._cacheTimestamp, prependURL, "videoAlternativeLoader" + this._id);
                            for (var i = 0; i < videoAlternative.length; i++) this._videoAlternativeLoader.addResource(videoAlternative[i], "images/" + videoAlternative[i]);
                            this._resourcesLoader.addLoader(this._videoAlternativeLoader)
                        } else throw new Error("Video alternative should always be provided")
                    };
                    return LayoutLoader
                }(loading.BaseLoader);
                loading.LayoutLoader = LayoutLoader
            }(loading = library.loading || (library.loading = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            ! function(loading) {
                var LoaderEvent = com.egt.library.events.LoaderEvent;
                var LoadingQueue = function(_super) {
                    ...
                    function LoadingQueue(asyncScriptExecution, id) {
                        ...
                        _this._progress = 0;
                        _this._id = id;
                        if (void 0 != _this._id) loading.Loader.addLoader(_this);
                        _this._state = loading.BaseLoader.STATE_IDLE;
                    ...
                    LoadingQueue.prototype.isIdle = function() {
                        return this._state == loading.BaseLoader.STATE_IDLE
                    };
                    LoadingQueue.prototype.isLoading = function() {
                        return this._state == loading.BaseLoader.STATE_LOADING
                    };
                    LoadingQueue.prototype.isLoaded = function() {
                        return this._state == loading.BaseLoader.STATE_LOADED
                    };
                    LoadingQueue.prototype.hasError = function() {
                        return this._state == loading.BaseLoader.STATE_ERROR
                    };
                    LoadingQueue.prototype.addLoader = function(loader) {
                        var loadersArray = loader instanceof loading.ScriptLoader ? this._scriptLoaders : this._loaders;
                        var loaderIndex = loadersArray.indexOf(loader);
                        if (loaderIndex != -1) return;
                        loadersArray.push(loader);
                        loader.addEventListener(LoaderEvent.COMPLETE, this.onLoaderLoaded, this);
                        loader.addEventListener(LoaderEvent.PROGRESS, this.onLoaderProgress, this);
                        loader.addEventListener(LoaderEvent.ERROR, this.onLoaderError, this);
                        this._loadersCount++;
                        if (this.isLoading()) loader.load()
                    };
                    ...
                    LoadingQueue.prototype.load = function() {
                        ...
                        this._progress = 0;
                        this._state = loading.BaseLoader.STATE_LOADING;
                        for (var loaderIndex in this._loaders) this._loaders[loaderIndex].load();
                        if (0 != this._scriptLoaders.length)
                            if (this._asyncScriptExecution)
                                for (var loaderIndex in this._scriptLoaders) this._scriptLoaders[loaderIndex].load();
                            else this._scriptLoaders[0].load()
                    };
                    LoadingQueue.prototype.stop = function() {
                        if (this._state != loading.BaseLoader.STATE_LOADING) return;
                        this._state = loading.BaseLoader.STATE_IDLE;
                        var length = this._loaders.length;
                        for (var i = 0; i < length; i++) this._loaders[i].stop();
                        length = this._scriptLoaders.length;
                        for (var i = 0; i < length; i++) this._scriptLoaders[i].stop()
                    };
                    LoadingQueue.prototype.getData = function() {
                        return null
                    };
                    LoadingQueue.prototype.dispose = function() {
                        if (void 0 != this._id) loading.Loader.removeLoader(this);
                        var loaderIndex;
                        var length = this._loaders.length;
                        for (loaderIndex = 0; loaderIndex < length; loaderIndex++) this.disposeLoader(this._loaders[loaderIndex]);
                        length = this._scriptLoaders.length;
                        for (loaderIndex = 0; loaderIndex < length; loaderIndex++) this.disposeLoader(this._scriptLoaders[loaderIndex]);
                    ...
                    LoadingQueue.prototype.removeLoaderListeners = function(loader) {
                        loader.removeEventListener(LoaderEvent.COMPLETE, this.onLoaderLoaded, this);
                        loader.removeEventListener(LoaderEvent.PROGRESS, this.onLoaderProgress, this);
                        loader.removeEventListener(LoaderEvent.ERROR, this.onLoaderError, this)
                    };
                    LoadingQueue.prototype.loaderHasLoaded = function(event) {
                        if (event) this.dispatchEvent(new LoaderEvent(LoaderEvent.CHILD_COMPLETE, event.data), event.target);
                    ...
                    LoadingQueue.prototype.onLoaderLoaded = function(event) {
                        if (this._state == loading.BaseLoader.STATE_ERROR || this._state == loading.BaseLoader.STATE_IDLE) return;
                        if (event.target instanceof loading.ScriptLoader && !this._asyncScriptExecution) {
                            var loaderIndex = this._scriptLoaders.indexOf(event.target);
                            if (loaderIndex < this._scriptLoaders.length - 1) this._scriptLoaders[loaderIndex + 1].load()
                        }
                    ...
                    LoadingQueue.prototype.onLoaderProgress = function(event) {
                        ...
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.CHILD_PROGRESS, event.data), event.target);
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.PROGRESS, data))
                    };
                    LoadingQueue.prototype.onLoaderError = function(event) {
                        this.stop();
                        this._state = loading.BaseLoader.STATE_ERROR;
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.CHILD_ERROR, event.data), event.target);
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.ERROR))
                    };
                    return LoadingQueue
                }(loading.Loader);
                loading.LoadingQueue = LoadingQueue
            }(loading = library.loading || (library.loading = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            ! function(loading) {
                var LoaderEvent = com.egt.library.events.LoaderEvent;
                var PIXILoader = function(_super) {
                    ...
                    PIXILoader.prototype.getTextureSequence = function(sequenceName, extension, texturesCount, sequenceDigitsCount) {
                        if (sequenceDigitsCount === void 0) sequenceDigitsCount = 3;
                        var textures = [];
                        if (void 0 == texturesCount) texturesCount = this.getTexturesCount();
                        for (var i = 0; i < texturesCount; i++) textures[i] = this.getTexture(sequenceName + library.Utils.convertToSequenceString(i, sequenceDigitsCount) + "." + extension);
                        return textures
                    };
                    ...
                    PIXILoader.prototype.dispose = function() {
                        ...
                        for (var key in this._textures) this._textures[key].destroy(true);
                        _super.prototype.dispose.call(this)
                    };
                    ...
                    PIXILoader.prototype.collectTextures = function() {
                        ...
                        for (var resKey in resources)
                            if (resources[resKey].isImage) {
                                ...
                                var jsonName = void 0;
                                if (index != -1) jsonName = resKey.slice(0, index);
                                if (resources[jsonName] && resources[jsonName].isJson)
                                    for (var textureName in resources[jsonName].textures) this._textures[textureName] = resources[jsonName].textures[textureName];
                                else this._textures[resKey] = resources[resKey].texture
                            }
                    };
                    PIXILoader.prototype.onLoaded = function(event) {
                        if (event) {
                            ...
                            for (var key in this._pixiLoader.resources)
                                if (null != this._pixiLoader.resources[key].error) {
                                    this.onError(null);
                                    return
                                } this.collectTextures()
                        } else this.dispatchEvent(new LoaderEvent(LoaderEvent.PROGRESS, {
                            progress: 1,
                            progressChange: 0
                        }));
                        this._state = loading.BaseLoader.STATE_LOADED;
                    ...
                    PIXILoader.prototype.onError = function(event) {
                        if (this._state == loading.BaseLoader.STATE_ERROR) return;
                        this._state = loading.BaseLoader.STATE_ERROR;
                        this._pixiLoader.reset();
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.ERROR))
                    };
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            ! function(loading) {
                ...
                loading.ScriptLoader = ScriptLoader
            }(loading = library.loading || (library.loading = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            ! function(loading) {
                ...
                var SoundLoader = function(_super) {
                    ...
                    SoundLoader.prototype.onLoaded = function(event) {
                        ...
                        if (!library.Device.isSoundSupported()) {
                            ...
                            var self = this;
                            if (null == window.audioContextInstance) window.audioContextInstance = new(library.Device.getAudioContext());
                ...
                loading.SoundLoader = SoundLoader
            }(loading = library.loading || (library.loading = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(loading) {
                ...
                var VideoLoader = function(_super) {
                    ...
                    VideoLoader.prototype.onLoaded = function(event) {
                        ...
                        this._video.src = URL.createObjectURL(this._request.response);
                    ...
                    VideoLoader.prototype.onDecodeError = function() {
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.DECODE_ERROR))
                    };
                ...
                loading.VideoLoader = VideoLoader
            }(loading = library.loading || (library.loading = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(loading) {
                ...
                var XMLLoader = function(_super) {
                    ...
                    XMLLoader.prototype.onLoaded = function(event) {
                        this.dispatchEvent(new LoaderEvent(LoaderEvent.COMPLETE, this._request.response))
                    };
            ...
            ! function(utils) {
                var BrowserDetect = function() {
                    ...
                    BrowserDetect.detect = function() {
                        if ("undefined" !== typeof navigator) return BrowserDetect.parseUserAgent(navigator.userAgent);
                        return null
                    };
                    ...
                    BrowserDetect.parseUserAgent = function(userAgentString) {
                        ...
                        var detected = browsers.map(function(browser) {
                            ...
                            if (version && version.length < 3) version = version.concat(1 == version.length ? [0, 0] : [0]);
                            return match && {
                                name: browser.name,
                                version: version.join(".")
                            }
                        }).filter(Boolean)[0] || null;
                        if (detected) detected.os = BrowserDetect.detectOS(userAgentString);
...
! function(com) {
    var egt;
    ! function(egt) {}(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
! function(com) {
    var egt;
    ! function(egt) {
        var library;
        ! function(library) {
            var BrowserDetect = com.egt.library.utils.BrowserDetect;
            var LogServer = function() {
                function LogServer() {}
                LogServer.sendStatisticUsage = function(data) {};
                LogServer.sendError = function(e) {
                    e.projectName = e.projectName || com.egt.projectMetadata.projectName;
                    e.projectBuild = e.projectBuild || com.egt.projectMetadata.projectBuild;
                    LogServer.postData(LogServer.serverPostError, e)
                };
                ...
                LogServer.ErrorLogServerAdress = "";
                LogServer.LogObjectServerAdress = "";
        ...
        ! function(library) {
            ...
            var MobileView = function(_super) {
                ...
                Object.defineProperty(MobileView, "deviceOrientation", {
                    get: function() {
                        return Device.currentOrientation
                    },
                    enumerable: true,
                    configurable: true
                });
                MobileView.listenForOrientationChange = function() {
                    MobileView._currentOrientation = Device.currentOrientation;
        ...
        ! function(library) {
            ...
            ! function(players) {
                ...
                ! function(MediaEvents) {
                    MediaEvents["play"] = "play";
                    MediaEvents["pause"] = "pause";
                    MediaEvents["ended"] = "ended";
                    MediaEvents["error"] = "error";
                    MediaEvents["videoReady"] = "videoReady"
                }(MediaEvents = players.MediaEvents || (players.MediaEvents = {}))
            }(players = library.players || (library.players = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
var com;
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            ! function(utils) {
                var log;
                ! function(log_1) {
                    log_1.log = LogFunction("log");
                    log_1.warn = LogFunction("warn");
                    log_1.error = LogFunction("error");
                    log_1.isEnabled = false;
                    log_1.isStylized = false;
                    var Config = function() {
                        function Config() {
                    ...
                    function decorator() {
                        ...
                        switch (args.length) {
                            ...
                            case 3:
                                if ("number" === typeof args[2]) return logParameter.apply(this, args);
                                else if ("undefined" === typeof args[2]) return logProperty.apply(this, args);
                                return logMethod.apply(this, args);
                            default:
                                throw new Error("Decorators are not valid here!")
                        }
                    }
                    log_1.decorator = decorator;

                    function decoratorConfig(config) {
                        return function(target) {
                            return logClass(target, config)
                        }
                    }
                    log_1.decoratorConfig = decoratorConfig;
                    ...
                    function output(level) {
                        ...
                        if ("string" === typeof args[0]) args[0] = "[EGT][" + this + "] " + args[0];
                        else args.unshift("[EGT][" + this + "]");
                    ...
                    function outputStylized(instance, level, style) {
                        ...
                        } else args.unshift("[EGT][%c" + instance, style, "]");
                        console[level].apply(console, args)
                    }

                    function addToStringMethod(prototype) {
                        if (prototype && !prototype.hasOwnProperty("toString")) Object.defineProperty(prototype, "toString", {
                            value: function() {
                    ...
                    if (true) {
                        logClass = function(target, config) {
                            var constructorName = target.prototype.constructor["name"];
                            var objectProperties = {};
                            var isForceEnabled = false;
                            var isForceDisabled = false;
                            var isForceStylizedEnabled = false;
                            var isForceStylizedDisabled = false;
                            var style;
                            if (config) {
                                if ("string" === typeof config.style) style = config.style;
                                if ("boolean" === typeof config.isEnabled) {
                                    isForceEnabled = config.isEnabled ? true : false;
                                    isForceDisabled = !isForceEnabled
                                }
                                if ("boolean" === typeof config.isStylized) {
                                    isForceStylizedEnabled = config.isStylized ? true : false;
                                    isForceStylizedDisabled = !isForceStylizedEnabled
                                }
                            }
                            if ("string" !== typeof style)
                                if (/View$/.test(constructorName)) style = "color: #41BBD9;";
                                else if (/Model$/.test(constructorName)) style = "color: #99C24D;";
                            else if (/Controller$/.test(constructorName)) style = "color: #F18F01;";
                            logMethods.forEach(function(level) {
                                objectProperties[level] = {
                                    value: function() {
                                        var args = [];
                                        for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
                                        if (isForceEnabled || log_1.isEnabled && !isForceDisabled)
                                            if (isForceStylizedEnabled || log_1.isStylized && !isForceStylizedDisabled) outputStylized.apply(void 0, [this, level, style].concat(args));
                                            else output.apply(void 0, [this, level].concat(args))
                                    }
                                }
                            });
                            Object.defineProperties(target.prototype, objectProperties);
                            addToStringMethod(target.prototype);
                            return target
                        };
                        logProperty = function(target, key) {
                            var value = this[key];
                            var getter = function() {
                                output(target, "log", "Get " + target + "." + key + " => " + value);
                                return value
                            };
                            var setter = function(newValue) {
                                output(target, "log", "Set " + target + "." + key + " => " + newValue);
                                value = newValue
                            };
                        ...
                        logMethod = function(target, key, descriptor) {
                            addToStringMethod(target);
                            var originalMethod = descriptor.value;
                            descriptor.value = function() {
                                var args = [];
                                for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
                                var resultString;
                                var argsString = args.map(function(a) {
                                    try {
                                        return stringify(a)
                                    } catch (e) {
                                        return String(a)
                                ...
                                var label = this + "." + key + "(" + argsString + ")";
                                output(this, "log", "Call: " + label);
                                ...
                                output(this, "log", "Result: " + label + " => " + resultString);
                                return result
                            };
                            return descriptor
                        };
                        logParameter = function(target, key, index) {
                            output(target, "log", target + "." + key + "(" + index + ")")
                        }
                    } else {
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            var players;
            ! function(players) {
                var log = com.egt.library.utils.log;
                ...
                var VideoPlayer = function(_super) {
                    ...
                    function VideoPlayer(loaderId, loop, autoPlay, muted, volume, fps) {
                    ...
                    VideoPlayer.prototype.play = function() {
                        this.log("Requesting playback, current time[%s]...", this.currentTime);
                        this.attachEvents();
                    ...
                    VideoPlayer.prototype.destroy = function() {
                        ...
                        this._outputCanvasContext = null;
                        _super.prototype.destroy.call(this, true, true)
                    };
                    Object.defineProperty(VideoPlayer.prototype, "fps", {
                        get: function() {
                            return 1e3 / this._frameProcessIntervalMs
                        },
                        set: function(value) {
                            this._frameProcessIntervalMs = 1e3 / value
                        },
                        enumerable: true,
                        configurable: true
                    });
                    ...
                    Object.defineProperty(VideoPlayer.prototype, "ended", {
                        get: function() {
                    ...
                    Object.defineProperty(VideoPlayer.prototype, "width", {
                        ...
                        set: function(value) {
                            this.warn("Unable to change width of video. Use scale instead.")
                        },
                        enumerable: true,
                        configurable: true
                    });
                    Object.defineProperty(VideoPlayer.prototype, "height", {
                        ...
                        set: function(value) {
                            this.warn("Unable to change height of video. Use scale instead.")
                        },
                        enumerable: true,
                        configurable: true
                    });
                    Object.defineProperty(VideoPlayer.prototype, "paused", {
                        get: function() {
                    ...
                    VideoPlayer.prototype.createElements = function() {
                        this._outputCanvas = new PIXI.CanvasBuffer(this._width, this._height).canvas;
                        this._outputTexture = new PIXI.BaseTexture(this._outputCanvas);
                        this.texture = new PIXI.Texture(this._outputTexture);
                        this._outputCanvasContext = this._outputCanvas.getContext("2d")
                    };
                    VideoPlayer.prototype.setResolution = function() {
                        this._width = this._video.videoWidth;
                        this._height = this._video.videoHeight
                    };
                    VideoPlayer.prototype.loadVideo = function() {
                        var _this = this;
                        this._video = Loader.getLoader(this.loaderId).getData();
                        this.setResolution();
                        this.log("Video resolution[%sx%s] container resolution[%sx%s]", this._video.videoWidth, this._video.videoHeight, this._width, this._height);
                    ...
                    VideoPlayer.prototype.onTimeUpdate = function() {
                        this.log("Time update current time[%s]...", this.currentTime);
                        if (!this._isPlaying && this.currentTime > 0) {
                            this._isVideoReady = true;
                            this._play();
                            this.emit(MediaEvents.videoReady)
                        }
                    };
                    VideoPlayer.prototype.processFrame = function() {
                        this._outputCanvasContext.drawImage(this._video, 0, 0);
                        this._outputTexture.update()
                    };
                    VideoPlayer.prototype.onEnded = function() {
                        this.log("Playback ended, current time[%s]", this.currentTime);
                        this._pause(true);
                        this.detachEvents();
                        this.emit(MediaEvents.ended)
                    };
                    VideoPlayer.prototype.onPlay = function() {
                        this.log("Playback started from[%s]sec fps[%s] loop[%s] volume[%s] muted[%s]", this.currentTime, this.fps, this.loop, this.volume, this.muted);
                        if (this._isVideoReady) this._play();
                        this.emit(MediaEvents.play)
                    };
                    VideoPlayer.prototype.onPause = function() {
                        this.log("Playback paused at[%s]sec", this.currentTime);
                        this._pause(true);
                        this.emit(MediaEvents.pause)
                    };
                    VideoPlayer.prototype.onError = function() {
                        this.error("Playback error code[%s] message", this._video.error.code, this._video.error.message);
                        this.emit(MediaEvents.error, this._video.error)
                    };
                    VideoPlayer.prototype.attachEvents = function() {
                        if (this._video) {
                        ...
                        } else this.warn("There is no video to attach event to")
                    };
                    VideoPlayer.prototype.detachEvents = function() {
                        if (this._video) {
                        ...
                        } else this.warn("There is no video to detach event from")
                    };
                    VideoPlayer.prototype._play = function() {
                        var _this = this;
                        if (this._isPlaying) return this.warn("Already playing current time[%s]...", this.currentTime);
                        this.log("Starting processing frames current time[%s]...", this.currentTime);
                        this._isPlaying = true;
                        this.processFrame();
                        this._frameProcessInterval = setInterval(function() {
                            return _this.processFrame()
                        }, this._frameProcessIntervalMs)
                    };
                    VideoPlayer.prototype._pause = function(processLastFrame) {
                        if (processLastFrame === void 0) processLastFrame = false;
                        if (!this._isPlaying) return this.warn("Already paused current time[%s]...", this.currentTime);
                        if (processLastFrame) this.processFrame();
                        this.log("Stopped processing frames current time[%s]...", this.currentTime);
                        this._isPlaying = false;
                        clearInterval(this._frameProcessInterval)
                    };
                    VideoPlayer.prototype.toString = function() {
                        return this.constructor["name"] + " " + this.loaderId
                    };
                    VideoPlayer = __decorate([log.decorator], VideoPlayer);
                    return VideoPlayer
                }(PIXI.Sprite);
                players.VideoPlayer = VideoPlayer
            }(players = library.players || (library.players = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            var players;
            ! function(players) {
                var VideoPlayerAlpha = function(_super) {
                    __extends(VideoPlayerAlpha, _super);

                    function VideoPlayerAlpha() {
                        return null !== _super && _super.apply(this, arguments) || this
                    }
                    VideoPlayerAlpha.prototype.destroy = function() {
                        this._bufferCanvas = null;
                        this._bufferCanvasContext = null;
                        _super.prototype.destroy.call(this)
                    };
                    VideoPlayerAlpha.prototype.createElements = function() {
                        _super.prototype.createElements.call(this);
                        this._bufferCanvas = new PIXI.CanvasBuffer(this._video.videoWidth, this._video.videoHeight).canvas;
                        this._bufferCanvasContext = this._bufferCanvas.getContext("2d")
                    };
                    VideoPlayerAlpha.prototype.setResolution = function() {
                        this._width = this._video.videoWidth;
                        this._height = this._video.videoHeight / 2
                    };
                    VideoPlayerAlpha.prototype.processFrame = function() {
                        this._bufferCanvasContext.drawImage(this._video, 0, 0);
                        var image = this._bufferCanvasContext.getImageData(0, 0, this._width, this._height),
                            imageData = image.data,
                            alphaData = this._bufferCanvasContext.getImageData(0, this._height, this._width, this._height).data;
                        for (var i = 3, len = imageData.length; i < len; i += 4) imageData[i] = alphaData[i - 1];
                        this._outputCanvasContext.putImageData(image, 0, 0, 0, 0, this._width, this._height);
                        this._outputTexture.update()
                    };
                    return VideoPlayerAlpha
                }(players.VideoPlayer);
                players.VideoPlayerAlpha = VideoPlayerAlpha
            }(players = library.players || (library.players = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            var sound;
            ! function(sound) {
                var SoundLoader = com.egt.library.loading.SoundLoader;
                var LoaderEvent = com.egt.library.events.LoaderEvent;
                var EventDispatcher = com.egt.library.events.EventDispatcher;
                var Device = com.egt.library.Device;
                var events = com.egt.library.events;
                var log = com.egt.library.utils.log;
                var SoundManager = function(_super) {
                    ...
                    SoundManager.prototype.registerSounds = function(sounds, prependURL, cacheTimestamp) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            var soundLoader = new SoundLoader(this._soundSources[id], cacheTimestamp || this._cacheTimestamp, prependURL, id);
                            soundLoader.addEventListener(LoaderEvent.COMPLETE, this.onSoundLoaded, this);
                            soundLoader.addEventListener(LoaderEvent.ERROR, this.onSoundError, this);
                            this._soundLoaders[id] = soundLoader
                        }
                    };
                    SoundManager.prototype.hasSound = function(soundName) {
                        if (!this._sounds[soundName]) return false;
                        return true
                    };
                    SoundManager.prototype.isSoundLoaded = function(soundName) {
                        if (!this._sounds[soundName] || !this._soundBuffers[this._sounds[soundName].soundId]) return false;
                        return true
                    };
                    SoundManager.prototype.load = function(id) {
                        if (!this._audioContext || void 0 !== this._soundBuffers[id]) return;
                        this._soundBuffers[id] = null;
                        this._soundLoaders[id].load()
                    };
                    SoundManager.prototype.loadAll = function() {
                        for (var key in this._soundSources) this.load(key)
                    };
                    SoundManager.prototype.getSoundDuration = function(soundName) {
                        var soundInfo = this._sounds[soundName];
                        if (!soundName || !this._audioContext || !soundInfo || !this._soundBuffers[soundInfo.soundId]) return -1;
                        return soundInfo.duration
                    };
                    SoundManager.prototype.play = function(soundName, loop, volume) {
                        if (loop === void 0) loop = false;
                        if (volume === void 0) volume = 1;
                        if (!soundName || !this._audioContext || !this._sounds[soundName] || !this._soundBuffers[this._sounds[soundName].soundId]) {
                            this.warn("Unable to play sound[%s]", soundName);
                            return null
                        }
                        if ("suspended" == this._audioContext.state && void 0 !== this._audioContext.resume) {
                    ...
                    Object.defineProperty(SoundManager.prototype, "isContextSuspended", {
                        get: function() {
                            return this._audioContext && "suspended" == this._audioContext.state ? true : false
                        },
                        enumerable: true,
                        configurable: true
                    });
                    Object.defineProperty(SoundManager.prototype, "isMuted", {
                        ...
                        set: function(value) {
                            ...
                            this._mute = value;
                            if (this._mute) this._masterGain.gain.value = 0;
                            else this._masterGain.gain.value = 1
                        },
                        enumerable: true,
                        configurable: true
                    });
                    SoundManager.prototype.dispose = function() {
                        for (var key in this._soundLoaders) {
                            ...
                            soundLoader.removeEventListener(LoaderEvent.COMPLETE, this.onSoundLoaded, this);
                            soundLoader.removeEventListener(LoaderEvent.ERROR, this.onSoundError, this);
                            soundLoader.dispose()
                        }
                        _super.prototype.dispose.call(this)
                    };
                    SoundManager.prototype.onSoundLoaded = function(event) {
                        event.target.removeEventListener(LoaderEvent.COMPLETE, this.onSoundLoaded, this);
                        event.target.removeEventListener(LoaderEvent.ERROR, this.onSoundError, this);
                        var id = event.target.id;
                        this.log("Sound loaded[%s]", this._soundSources[id]);
                        this._soundBuffers[id] = event.data;
                        this.dispatchEvent(new events.Event(SoundManager_1.SOUND_LOADED, {
                            soundId: id
                        }))
                    };
                    ...
                    SoundManager = SoundManager_1 = __decorate([log.decoratorConfig({
                        style: "color: #A3D9FF"
                    })], SoundManager);
                    return SoundManager;
                    var SoundManager_1
                ...
                var StreamSoundInstance = function(_super) {
                    ...
                    StreamSoundInstance.prototype.onSoundEnded = function() {
                        this.dispatchEvent(new events.Event("ended"))
                    };
                ...
                var SoundInstance = function(_super) {
                    ...
                    function SoundInstance(source, masterGain, soundInfo, loop) {
                        ...
                        _this.log("Started");
                        if (loop) _this._source.start(0, _this._soundInfo.start);
                        else {
                            _this._onEndDelay = TweenMax.delayedCall(soundInfo.duration, _this.onSoundEnded, null, _this);
                    ...
                    SoundInstance.prototype.stop = function() {
                        if (!this._isStopped) {
                            ...
                            this._source.stop();
                            if (null != this._onEndDelay) this._onEndDelay.totalTime(this._onEndDelay.totalDuration())
                        }
                    };
                    SoundInstance.prototype.onSoundEnded = function() {
                        if (!this._hasSoundEned) {
                            this.log("Ended");
                            this._hasSoundEned = true;
                            if (this._onEndDelay) {
                    ...
                    SoundInstance = __decorate([log.decoratorConfig({
                        style: "color: #006E90"
                    })], SoundInstance);
                    return SoundInstance
                }(EventDispatcher)
            }(sound = library.sound || (library.sound = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
var com;
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            var utils;
            ! function(utils) {
                var CanvasConsoleConfig = function() {
                    function CanvasConsoleConfig() {
                        ...
                        this.backgroundColor = 1048575;
                        this.scrollButtonsColor = 16776960;
                        this.showOnError = true
                    }
                    return CanvasConsoleConfig
                }();
                utils.CanvasConsoleConfig = CanvasConsoleConfig;
                var CanvasConsole = function(_super) {
                    ...
                    function CanvasConsole(config) {
                        ...
                        if (!config) config = new CanvasConsoleConfig;
                        _this.config = config;
                        _this.init();
                    ...
                    CanvasConsole.getInstance = function() {
                        if (!this.instance) this.instance = new CanvasConsole;
                    ...
                    CanvasConsole.prototype.print = function(message, color, fontSize) {
                        if (color === void 0) color = 16777215;
                        if (fontSize === void 0) fontSize = 30;
                        var text = new PIXI.Text(message, {
                            fill: color,
                            fontSize: fontSize,
                            wordWrap: true,
                            wordWrapWidth: this.config.consoleWidth - CanvasConsole.TEXT_STARTING_X
                        });
                        var currentTextHeight = this.consoleContainer.children.map(function(textContainer) {
                            return textContainer.height + CanvasConsole.TEXT_Y_SPACING
                        }).reduce(function(totalHeight, currentHeight) {
                        ...
                        if (CanvasConsole.TEXT_STARTING_Y + currentTextHeight > this.config.consoleHeight) this.consoleContainer.y = -currentTextHeight;
                        return this
                    };
                    CanvasConsole.prototype.clearConsole = function() {
                        while (this.consoleContainer.children.length > 0) this.consoleContainer.removeChildAt(0);
                        this.errorCounter = 0;
                    ...
                    CanvasConsole.prototype.scrollUp = function(timesScroll) {
                        if (timesScroll === void 0) timesScroll = 1;
                        if (this.consoleContainer.y < CanvasConsole.SCROLLING_Y_STEP) this.consoleContainer.y += CanvasConsole.SCROLLING_Y_STEP * timesScroll;
                        return this
                    };
                    ...
                    CanvasConsole.prototype.init = function() {
                        ...
                        if (this.config.addHideButton) {
                            this.hideButton = this.getRect(6877101, 70, 70);
                        ...
                        if (this.config.addScrollButtons) {
                            ...
                            this.scrollUpButton.anchor.x = this.scrollUpButton.anchor.y = this.scrollDownButton.anchor.x = this.scrollDownButton.anchor.y = .5;
                    ...
                    CanvasConsole.prototype.attachToConsole = function() {
                        ...
                        var self = this;
                        if (this.config.attatchConsoleLog) console.log = function() {
                            this.log(arguments[0]);
                            return origLog.apply(this, arguments)
                        };
                        if (this.config.attatchConsoleError) {
                            window.addEventListener("error", function(e) {
                                if (self.config.showOnError) self.show();
                                if (e.error.stack) _this.printError(_this.errorCounter + ". " + e.message + "\n\t" + e.error.stack.split("@").join("\n\t"));
                    ...
                    CanvasConsole.prototype.printError = function(message) {
                        this.errorCounter++;
                        this.print(message, 16711680)
                    };
                    CanvasConsole.prototype.setupScrollButtonsEvents = function(on) {
                        if (on === void 0) on = true;
                        if (on) {
                            this.scrollUpButton.on(library.Device.resolveEvent("click"), this.onScrollUpButtonClicked, this);
                            this.scrollDownButton.on(library.Device.resolveEvent("click"), this.onScrollDownButtonClicked, this)
                        } else {
                            this.scrollUpButton.off(library.Device.resolveEvent("click"), this.onScrollUpButtonClicked, this);
                            this.scrollDownButton.off(library.Device.resolveEvent("click"), this.onScrollDownButtonClicked, this)
                        }
                    };
                    CanvasConsole.prototype.setupHideButtonEvents = function(on) {
                        if (on === void 0) on = true;
                        if (on) this.hideButton.on(library.Device.resolveEvent("click"), this.onHideButtonClicked, this);
                        else this.hideButton.off(library.Device.resolveEvent("click"), this.onHideButtonClicked, this)
                    };
                    ...
                    CanvasConsole.prototype.getTriangle = function(color) {
                        ...
                        triangle.endFill();
                        var result = new PIXI.Sprite(triangle.generateTexture(PIXI.renderer));
                    ...
                    CanvasConsole.prototype.getRect = function(color, width, height) {
                        ...
                        rect.endFill();
                        var result = new PIXI.Sprite(rect.generateTexture(PIXI.renderer));
                        result.interactive = true;
                        return result
                    };
                ...
                utils.CanvasConsole = CanvasConsole
            }(utils = library.utils || (library.utils = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            ! function(utils) {
                ...
                utils.decimalToHexColorString = decimalToHexColorString
            }(utils = library.utils || (library.utils = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(utils) {
                var ErrorSerializer = function() {
                    ...
                    ErrorSerializer.Serialize = function(value) {
                        if ("object" === typeof value) return ErrorSerializer.destroyCircular(value, []);
                    ...
                    ErrorSerializer.destroyCircular = function(from, seen) {
                        ...
                        if ("string" === typeof from.name) to.name = from.name;
                        if ("string" === typeof from.message) to.message = from.message;
                        if ("string" === typeof from.stack) to.stack = from.stack;
                        var errorEventProps = ["message", "filename", "lineno", "colno", "error"];
                        errorEventProps.forEach(function(prop) {
                            if ("string" === typeof from[prop] || "number" === typeof from[prop]) {
                                to[prop] = from[prop];
                                return
                            }
                            if ("object" === typeof from[prop]) to[prop] = ErrorSerializer.Serialize(from[prop])
                        });
                        return to
                    };
                    return ErrorSerializer
                }();
                utils.ErrorSerializer = ErrorSerializer
            }(utils = library.utils || (library.utils = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
        ...
        ! function(library) {
            ...
            ! function(utils) {
                function sortCells(cells, isColFirst) {
                    ...
                    var cellIndex = 0,
                        leftCol, leftRow, rightCol, rightRow, isLeftColBigger, isLeftRowBigger, isRowSame, shouldSwap, colIndexOffset, rowIndexOffset;
                    if (isColFirst) {
                        colIndexOffset = 0;
                        rowIndexOffset = 1
                    } else {
                ...
                function splitIntoRows(cells, isColFirst, fillEmptyRows) {
                    ...
                    var cellIndex = 0,
                        col, row, colIndexOffset, rowIndexOffset;
                    if (isColFirst) {
                        colIndexOffset = 0;
                        rowIndexOffset = 1
                    } else {
                    ...
                    for (; cellIndex < lastCellIndex; cellIndex += 2) {
                        ...
                        if (isColFirst) result[row].push(col, row);
                        else result[row].push(row, col)
                    }
                    if (!fillEmptyRows) result = result.filter(function(row) {
                        return row
                    });
                    return result
                }
                utils.splitIntoRows = splitIntoRows
            }(utils = library.utils || (library.utils = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(utils) {
                ...
                var Timer = function(_super) {
                    ...
                    Timer.prototype.start = function() {
                        ...
                        this._delayedCall = TweenMax.delayedCall(this._delay, this.onDelay, null, this)
                    };
                    ...
                    Object.defineProperty(Timer.prototype, "isFinished", {
                        get: function() {
                            return this._currentCount >= this._repeatCount && 0 != this._repeatCount
                        },
                        enumerable: true,
                        configurable: true
                    });
                    Timer.prototype.onDelay = function() {
                        this._currentCount++;
                        this.dispatchEvent(new library.events.Event(Timer.TIMER));
                        if (this.isFinished) {
                            this.stop();
                            this.dispatchEvent(new library.events.Event(Timer.TIMER_COMPLETE))
            ...
            ! function(utils) {
                var UncaughtErrorsHandler = function() {
                    ...
                    UncaughtErrorsHandler.prototype._setupEvents = function(attatch) {
                        ...
                        if (attatch) {
                            if ("undefined" !== typeof window) window.addEventListener("error", this._callback)
                        } else if ("undefined" !== typeof window) window.removeEventListener("error", this._callback)
                    };
                    return UncaughtErrorsHandler
                }();
                utils.UncaughtErrorsHandler = UncaughtErrorsHandler
            }(utils = library.utils || (library.utils = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
        ...
        ! function(library) {
            var Utils = function() {
                ...
                Utils.convertToSequenceString = function(num, sequenceDigitsCount) {
                    ...
                    for (var i = sequenceString.length; i < sequenceDigitsCount; i++) sequenceString = "0".concat(sequenceString);
                ...
                Utils.formatMoney = function(num, denom, formatCurrency, noCoins, separator) {
                    ...
                    if (arr[1]) return prefix.join("") + "." + arr[1];
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            var widgets;
            ! function(widgets) {
                var BitmapMoneyText = function(_super) {
                    ...
                    function BitmapMoneyText(config) {
                        ...
                        if (void 0 == _this._config.centsFontSize) _this._config.centsFontSize = _this._config.moneyFontSize;
                        if (void 0 == _this._config.currencyFontSize) _this._config.currencyFontSize = _this._config.moneyFontSize;
                        if (void 0 == _this._config.suffixFontSize) _this._config.suffixFontSize = _this._config.moneyFontSize;
                        if (void 0 == _this._config.centsfontFamily) _this._config.centsfontFamily = _this._config.fontFamily;
                        if (void 0 == _this._config.currencyfontFamily) _this._config.currencyfontFamily = _this._config.fontFamily;
                        if (void 0 == _this._config.suffixfontFamily) _this._config.suffixfontFamily = _this._config.fontFamily;
                        _this._rect = new PIXI.Graphics;
                        _this._rect.beginFill(16711680, 1);
                        ...
                        _this._rect.alpha = 0;
                        if (_this._config.debug) _this._rect.alpha = 1;
                        ...
                        if (_this._config.diamond) {
                            ...
                            _this._diamondImage.anchor.set(.5);
                    ...
                    Object.defineProperty(BitmapMoneyText.prototype, "money", {
                        ...
                        set: function(value) {
                            ...
                            if (this._config.shouldHideWhenMoneyValueIsZero && 0 == value) {
                                this._moneyText.visible = false;
                                this._centsText.visible = false;
                                this._currencyText.visible = false;
                                if (this._diamondImage) this._diamondImage.visible = false
                            } else {
                                if (this._diamondImage) this._diamondImage.visible = true;
                                this._moneyText.visible = true;
                                this._centsText.visible = this._config.shouldCentsHaveValue;
                                this._currencyText.visible = !this._config.isShowingCredits && this._config.shouldShowCurrency && !this._config.diamond
                            }
                    ...
                    Object.defineProperty(BitmapMoneyText.prototype, "bounds", {
                        get: function() {
                            return {
                                width: this._config.bounds.width,
                                height: this._config.bounds.height
                            }
                        },
                        set: function(value) {
                            this._config.bounds = {
                    ...
                    BitmapMoneyText.prototype.recalcVerticalOffset = function() {
                        if (isNaN(this._config.centsPositionOffsetPercentY)) this._config.centsOffsetCalc(this._centsText.y, this._moneyText.textHeight);
                        if (isNaN(this._config.currencyPositionOffsetPercentY)) this._config.currencyOffsetCalc(this._currencyText.y, this._moneyText.textHeight)
                    };
                    ...
                    Object.defineProperty(BitmapMoneyText.prototype, "centsTextPositionY", {
                        set: function(y) {
                            this._centsText.y = y;
                            if (this._moneyText.textHeight > 0) this._config.centsOffsetCalc(this._centsText.y, this._moneyText.textHeight)
                        },
                        enumerable: true,
                        configurable: true
                    });
                    Object.defineProperty(BitmapMoneyText.prototype, "currencyTextPositionY", {
                        set: function(y) {
                            ...
                            if (this._moneyText.textHeight > 0) this._config.currencyOffsetCalc(this._currencyText.y, this._moneyText.textHeight)
                        },
                        enumerable: true,
                        configurable: true
                    });
                    ...
                    BitmapMoneyText.prototype.positionText = function() {
                        ...
                        if (this._config.diamond) this._diamondImage.y = this._moneyText.y + this._moneyText.textHeight / 2 + this._config.posDiamondY;
                        if ("left" == this._config.align) {
                        ...
                        } else if ("right" == this._config.align)
                            if (this._config.diamond) {
                                this._moneyText.x = this._config.bounds.width - this._moneyText.textWidth;
                                this._diamondImage.x = this._moneyText.x - this._config.spaceBetweenMoneyAndDiamond - this._diamondImage.width / 2 + this.moneyTextLetterSpacing
                            } else this._moneyText.x = this._config.bounds.width - this.textWidth;
                        else if (this._config.diamond) {
                            this._moneyText.x = (this._config.bounds.width - this.textWidth) / 2;
                            if (this._config.centerAlignOnlyMoney) {
                                this._moneyText.x += (this._diamondImage.width + this._config.spaceBetweenMoneyAndDiamond) / 2 - this.moneyTextLetterSpacing;
                            ...
                            this._moneyText.x = (this._config.bounds.width - this.textWidth) / 2;
                            if (this._config.centerAlignOnlyMoney && !this._config.isShowingCredits) this._moneyText.x += this._currencyText.width / 2
                        }
                        ...
                        if (!this._config.isShowingCredits && this._config.shouldShowCurrency) {
                            ...
                            this._currencyText.x = leftText.x + leftText.width + (!isNaN(this._config.currencyPositionOffsetPercentX) ? this._config.currencyPositionOffsetPercentX * this._moneyText.textHeight : 0);
                    ...
                    Object.defineProperty(BitmapMoneyText.prototype, "textWidth", {
                        get: function() {
                            ...
                            if (!this._config.isShowingCredits && !this._config.diamondPlay) this.calcHorizontalOffset();
                            var centsWidth = this._centsText.visible ? this._centsText.textWidth + (isNaN(this._config.spaceBetweenMoneyAndCents) ? 0 : this._config.spaceBetweenMoneyAndCents) : 0;
                            var currencyWidth = this._config.isShowingCredits || !this._config.shouldShowCurrency ? 0 : this._config.diamond ? this._diamondImage.width + this._config.spaceBetweenMoneyAndDiamond + this.moneyTextLetterSpacing : this._currencyText.textWidth + (isNaN(this._config.spaceBetweenCentsAndCurrency) ? 0 : this._config.spaceBetweenCentsAndCurrency);
                    ...
                    Object.defineProperty(BitmapMoneyText.prototype, "moneyTextLetterSpacing", {
                        get: function() {
                            ...
                            this.resetMoneyTextWidthHeight();
                            var letterSpacing = this._moneyText.children[1].x - this._moneyText.children[0].x - this._moneyText.children[0].width;
                            this._moneyText.text = this._config.moneyString;
                            this.resetMoneyTextWidthHeight();
                            if (letterSpacing < 0) letterSpacing /= 2;
                            else letterSpacing = 0;
                    ...
                    BitmapMoneyText.prototype.calcHorizontalOffset = function() {
                        ...
                        this._moneyText.text = this._config.moneyString;
                        this.resetMoneyTextWidthHeight();
                        if (!isNaN(this._config.centsPositionOffsetPercentX)) letterSpacing = 0;
                        this._config.spaceBetweenMoneyAndCents = letterSpacing + (!isNaN(this._config.centsPositionOffsetPercentX) ? this._config.centsPositionOffsetPercentX * this._moneyText.textHeight : 0);
                        this._centsText.text = "111111";
                        this.resetCentsTextWidthHeight();
                        letterSpacing = this._centsText.children[1].x - this._centsText.children[0].x - this._centsText.children[0].width;
                        this._centsText.text = this._config.centsString;
                        this.resetCentsTextWidthHeight();
                        if (!isNaN(this._config.currencyPositionOffsetPercentX)) letterSpacing = 0;
                        this._config.spaceBetweenCentsAndCurrency = letterSpacing + (!isNaN(this._config.currencyPositionOffsetPercentX) ? this._config.currencyPositionOffsetPercentX * this._moneyText.textHeight : 0)
                    };
                    ...
                    BitmapMoneyText.prototype.resetFonts = function() {
                        this._moneyText.font = {
                            tint: this._moneyText.font.tint,
                            align: "left",
                            name: this._config.fontFamily,
                            size: this._config.moneyFontSize
                        };
                        this._centsText.font = {
                            tint: this._centsText.font.tint,
                            align: "left",
                            name: this._config.centsfontFamily,
                            size: this._config.centsFontSize
                        };
                        this._currencyText.font = {
                            tint: this._currencyText.font.tint,
                            align: "left",
                            name: this._config.currencyfontFamily,
                            size: this._config.currencyFontSize
                        };
                        this._suffix.font = {
                            tint: this._suffix.font.tint,
                            align: "left",
                            name: this._config.suffixfontFamily,
                            size: this._config.suffixFontSize
                        };
                    ...
                    BitmapMoneyText.prototype.fitToBounds = function() {
                        this.resetFonts();
                        if (this._config.diamond) this.resizeDiamond();
                        if (!this._config.shouldFitToBounds) return;
                        var currencyCompensation = 0;
                        if (this._config.centerAlignOnlyMoney && "center" == this._config.align) currencyCompensation = this._config.diamond ? this._diamondImage.width + this._config.spaceBetweenMoneyAndDiamond : this._currencyText.width;
                        ...
                        while (this.textWidth > this._config.bounds.width - currencyCompensation && moneyFontSize > this._config.minFontSize) {
                            ...
                            if (null != this._config.diamond && !this._config.keepDiamondSize) this.resizeDiamond();
                            else if (!this._config.keepCurrencySize) this._currencyText.font = {
                                tint: this._currencyText.font.tint,
                                align: "left",
                                name: this._config.currencyfontFamily,
                ...
                widgets.BitmapMoneyText = BitmapMoneyText;
                var MoneyTextConfig = function(_super) {
                    ...
                    function MoneyTextConfig() {
                        ...
                        _this.centsfontFamily = void 0;
                        _this.currencyfontFamily = void 0;
                        _this.suffixfontFamily = void 0;
                        _this.align = "center";
                        ...
                        _this.centsFontSize = void 0;
                        _this.currencyFontSize = void 0;
                        _this.suffixFontSize = void 0;
                    ...
                    MoneyTextConfig.prototype.centsOffsetCalc = function(centsPosition, moneyTextHeight) {
                        if (0 == centsPosition) this.centsPositionOffsetPercentY = 0;
                        else this.centsPositionOffsetPercentY = centsPosition / moneyTextHeight
                    };
                    MoneyTextConfig.prototype.currencyOffsetCalc = function(currencyPosition, moneyTextHeight) {
                        if (0 == currencyPosition) this.currencyPositionOffsetPercentY = 0;
                        else this.currencyPositionOffsetPercentY = currencyPosition / moneyTextHeight
                    };
                    Object.defineProperty(MoneyTextConfig.prototype, "moneyString", {
                        get: function() {
                            var str = "";
                            if (this.isShowingCredits) str = Math.floor(this.money / this.denomination).toString();
                            else if (this.diamondPlay) str = Math.floor(this.money / 100).toString();
                            else {
                            ...
                            if (this.prefix) str = this.prefix + str;
                            return str
                        },
                        enumerable: true,
                        configurable: true
                    ...
                    Object.defineProperty(MoneyTextConfig.prototype, "centsString", {
                        get: function() {
                            var str = "";
                            if (this.shouldCentsHaveValue) str = (this.money / 100).toFixed(2).split(".")[1];
                            return str
                        },
                        enumerable: true,
                        configurable: true
                    ...
                    Object.defineProperty(MoneyTextConfig.prototype, "shouldCentsHaveValue", {
                        get: function() {
                            return !this.isShowingCredits && !this.diamondPlay && !this.hideCents && (this.money <= this.centsVisibilityMoneyLimit || this.centsVisibilityMoneyLimit < 0)
                        },
                        enumerable: true,
                        configurable: true
                    });
            ...
            }(widgets = library.widgets || (library.widgets = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
var com;
        ...
        ! function(library) {
            ...
            ! function(widgets) {
                var BitmapText = function(_super) {
                    ...
                    function BitmapText(config, text, font) {
                        var _this = _super.call(this) || this;
                        _this._config = new BitmapTextConfig;
                        _this._config.serialize(config);
                        _this._text = new PIXI.extras.BitmapText(text, font);
                        _this._originalFontSize = _this._text.font.size;
                        _this.drawDebugRect();
                    ...
                    Object.defineProperty(BitmapText.prototype, "config", {
                        set: function(conf) {
                    ...
                    Object.defineProperty(BitmapText.prototype, "font", {
                        ...
                        set: function(value) {
                            if (void 0 == value.size) value.size = this._originalFontSize;
                            this._text.font = value;
                            this._originalFontSize = this._text.font.size;
                            this.fitToBounds();
                            this.positionText()
                        },
                        enumerable: true,
                    ...
                    BitmapText.prototype.fitToBounds = function() {
                        if (!this._config.shouldScale) return;
                        this._text.font.size = this._originalFontSize;
                        var fontSize = this._text.font.size;
                        while (this._text.textWidth > this._config.bounds.width && fontSize > this._config.minFontSize) {
                            fontSize--;
                            this._text.font.size = fontSize;
                            this._text.font = this._text.font;
                            this._text.updateTransform()
                        }
                    };
                    Object.defineProperty(BitmapText.prototype, "textWidth", {
                        get: function() {
                            var textWidth = this._text.textWidth;
                            return textWidth
                        },
                        enumerable: true,
                        configurable: true
                    });
                    BitmapText.prototype.resetFont = function() {
                        this._text.font = {
                            tint: this._text.font.tint,
                            align: "left",
                            name: this._config.style.font.name,
                            size: this._config.style.font.size
                        };
                        this.resetTextWidthHeight()
                    };
                    BitmapText.prototype.resetTextWidthHeight = function() {
                        this._text.width;
                        this._text.height
                    };
                    BitmapText.prototype.positionText = function() {
                        if ("left" == this._config.align) this._text.x = 0;
                        else if ("center" == this._config.align) this._text.x = Math.round((this._config.bounds.width - this._text.width) / 2);
                        else if ("right" == this._config.align) this._text.x = Math.round(this._config.bounds.width - this._text.width);
                        if ("middle" === this._config.verticalAlign) this._text.y = Math.round((this._config.bounds.height - this._text.height) / 2);
                        else if ("top" === this._config.verticalAlign) this._text.y = 0;
                        else if ("bottom" === this._config.verticalAlign) this._text.y = Math.round(this._config.bounds.height - this._text.height)
                    };
                    BitmapText.prototype.drawDebugRect = function() {
                        if (this._rect) this._rect.destroy();
                        if (this._config.debug) {
                            this._rect = new PIXI.Graphics;
                            this._rect.beginFill(16711680);
                ...
                widgets.BitmapText = BitmapText;
                var BitmapTextConfig = function(_super) {
                    __extends(BitmapTextConfig, _super);

                    function BitmapTextConfig() {
                        var _this = null !== _super && _super.apply(this, arguments) || this;
                        _this.style = {
                            font: {
                                tint: null,
                ...
                widgets.BitmapTextConfig = BitmapTextConfig
            }(widgets = library.widgets || (library.widgets = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(widgets) {
                ...
                var Button = function(_super) {
                    ...
                    function Button(textures) {
                        ...
                        _this.on(Device.resolveEvent("mousedown"), _this.onMouseDown, _this);
                        _this.on(Device.resolveEvent("mouseup"), _this.onMouseUp, _this);
                        _this.on(Device.resolveEvent("mouseupoutside"), _this.onMouseUp, _this);
                        _this.on(Device.resolveEvent("mouseover"), _this.onMouseOver, _this);
                        _this.on(Device.resolveEvent("mouseout"), _this.onMouseOut, _this);
                    ...
                    Button.prototype.dispose = function() {
                        this.off(Device.resolveEvent("mousedown"), this.onMouseDown, this);
                        this.off(Device.resolveEvent("mouseup"), this.onMouseUp, this);
                        this.off(Device.resolveEvent("mouseupoutside"), this.onMouseUp, this);
                        this.off(Device.resolveEvent("mouseover"), this.onMouseOver, this);
                        this.off(Device.resolveEvent("mouseout"), this.onMouseOut, this);
                        if (this._scaleTween) this._scaleTween.kill()
                    };
                    Object.defineProperty(Button.prototype, "textures", {
                        set: function(value) {
                            if (null == value[Button.STATE_UP]) throw "At least a 'state up' should be supplied";
                    ...
                    Button.prototype.setImageForState = function(state) {
                        if (void 0 === this._textures[state]) state = Button.STATE_UP;
                        if (!this.interactive && void 0 !== this._textures[Button.STATE_DISABLED]) state = Button.STATE_DISABLED;
                        else if (this.interactive && this._state == Button.STATE_DISABLED) state = Button.STATE_UP;
                        else if (!this.interactive && void 0 === this._textures[Button.STATE_DISABLED]) state = Button.STATE_UP;
                        this._state = state;
                        this._background.texture = this._textures[state]
                    };
                    ...
                    Button.prototype.onMouseUp = function() {
                        this._isDown = false;
                        if (this._isOver) this.setImageForState(Button.STATE_OVER);
                        else this.setImageForState(Button.STATE_UP)
                    };
                    Button.prototype.onMouseOver = function() {
                        this._isOver = true;
                        if (!this._isDown) this.setImageForState(Button.STATE_OVER);
                        if (this.shouldScale) this._scaleTween = TweenMax.to(this.scale, .3, {
                            x: 1.1,
                            y: 1.1
                        })
                    };
                    Button.prototype.onMouseOut = function() {
                        this._isOver = false;
                        if (!this._isDown) this.setImageForState(Button.STATE_UP);
                        if (this.shouldScale && 1 != this.scale.x) this._scaleTween = TweenMax.to(this.scale, .3, {
                            x: 1,
                            y: 1
                        })
                    };
    ...
    ! function(egt) {
        ...
        ! function(library) {
            ...
            ! function(widgets) {
                ...
                widgets.DefaultBoxGenerator = DefaultBoxGenerator
            }(widgets = library.widgets || (library.widgets = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(widgets) {
                ...
                var MoneyText = function(_super) {
                    ...
                    function MoneyText(config) {
                        ...
                        _this._config = new MoneyTextConfig;
                        _this._config.serialize(config);
                        if (_this._config.debug) _this.createDebugFields();
                        _this.createTextFields();
                        if (_this._config.diamond) {
                            _this._diamondImage = new PIXI.Sprite(_this._config.diamond);
                            _this.addChild(_this._diamondImage);
                    ...
                    Object.defineProperty(MoneyText.prototype, "money", {
                        ...
                        set: function(value) {
                            ...
                            var currencyVisible = this._currencyText.visible;
                            this._config.money = value;
                            this._moneyText.text = this._config.moneyString;
                            this._centsText.text = this._config.centsString;
                            if (this._config.shouldHideWhenMoneyValueIsZero && 0 == value) {
                            ...
                            if (0 != this._config.suffix.length) this._suffix.visible = true;
                            if (!this._lastCalculatedWidths || moneyLength !== this._moneyText.text.length || centsLength !== this._centsText.text.length || moneyVisible !== this._moneyText.visible || centsVisible !== this._centsText.visible || currencyVisible !== this._currencyText.visible) {
                                this.fitToBounds();
                                this.positionText()
                            }
                            if (this._config.debug) {
                                ...
                                this._integerDebug.width = this._lastCalculatedWidths.integer;
                                ...
                                this._decimalSymbolDebug.width = this._lastCalculatedWidths.decimalSymbol;
                                ...
                                this._decimalDebug.width = this._lastCalculatedWidths.decimal;
                    ...
                    Object.defineProperty(MoneyText.prototype, "moneyStyle", {
                        set: function(style) {
                            var moneyStyle = this._moneyText.style;
                            for (var key in style)
                                if ("fontSize" != key && "font" != key) moneyStyle[key] = style[key];
                            this._moneyText.style = moneyStyle;
                            this.fitToBounds();
                            this.positionText()
                        },
                    ...
                    Object.defineProperty(MoneyText.prototype, "centsStyle", {
                        set: function(style) {
                            var centsStyle = this._centsText.style;
                            for (var key in style)
                                if ("fontSize" != key && "font" != key) centsStyle[key] = style[key];
                            this._centsText.style = centsStyle;
                            this.fitToBounds();
                            this.positionText()
                        },
                    ...
                    Object.defineProperty(MoneyText.prototype, "currencyStyle", {
                        set: function(style) {
                            var currencyStyle = this._currencyText.style;
                            for (var key in style)
                                if ("fontSize" != key && "font" != key) currencyStyle[key] = style[key];
                            this._currencyText.style = currencyStyle;
                            this.fitToBounds();
                            this.positionText()
                        },
                    ...
                    Object.defineProperty(MoneyText.prototype, "suffixStyle", {
                        set: function(style) {
                            var suffixStyle = this._suffix.style;
                            for (var key in style)
                                if ("fontSize" != key && "font" != key) suffixStyle[key] = style[key];
                            this._suffix.style = suffixStyle;
                            this.fitToBounds();
                            this.positionText()
                        },
                    ...
                    MoneyText.prototype.destroy = function(destroyChildren) {
                        if (null != this._diamondImage && null != this._diamondImage.parent) this.removeChild(this._diamondImage);
                    ...
                    MoneyText.prototype.createDebugFields = function() {
                        ...
                        this._boundsDebug.beginFill(5765376, .5);
                        this._boundsDebug.drawRect(0, 0, 1, 1);
                        this._integerDebug.beginFill(13107243, .5);
                        this._integerDebug.drawRect(0, 0, 1, 1);
                        this._decimalSymbolDebug.beginFill(231154, .5);
                        this._decimalSymbolDebug.drawRect(0, 0, 1, 1);
                        this._decimalDebug.beginFill(14187776, .5);
                        this._decimalDebug.drawRect(0, 0, 1, 1);
                        this._currencyDebug.beginFill(10423536, .5);
                        this._currencyDebug.drawRect(0, 0, 1, 1);
                        this._suffixDebug.beginFill(16776960, .5);
                    ...
                    MoneyText.prototype.positionText = function() {
                        var moneyFontProps = PIXI.Text.fontPropertiesCache[this._moneyText.style.font];
                        var decimalSymbolFontProps = PIXI.Text.fontPropertiesCache[this._decimalSymbolText.style.font];
                        var centsFontProps = PIXI.Text.fontPropertiesCache[this._centsText.style.font];
                        var currencyFontProps = PIXI.Text.fontPropertiesCache[this._currencyText.style.font];
                        var suffixFontProps = PIXI.Text.fontPropertiesCache[this._suffix.style.font];
                        var w = this._lastCalculatedWidths;
                        if (0 == this._config.bounds.height) this._moneyText.y = 0;
                        else this._moneyText.y = (this._config.bounds.height - this._moneyText.height) / 2;
                        this._suffix.y = this._moneyText.y + moneyFontProps.ascent - suffixFontProps.ascent;
                        if (this._config.diamond) this._diamondImage.y = Math.round(this._moneyText.y + this._moneyText.height / 2);
                        if ("left" == this._config.align) {
                            this._moneyText.x = 0;
                            if (this._config.diamond) {
                            ...
                            if (this._config.diamond) {
                                ...
                                this._diamondImage.x = Math.round(this._moneyText.x - this._config.spaceBetweenMoneyAndDiamond - this._diamondImage.width / 2)
                            } else this._moneyText.x = this._config.bounds.width - (w.integer + w.decimal + w.decimalSymbol + w.currency + w.suffix);
                        else if (this._config.diamond) {
                            this._moneyText.x = (this._config.bounds.width - w.integer) / 2;
                            if (!this._config.centerAlignOnlyMoney) this._moneyText.x += (this._diamondImage.width + this._config.spaceBetweenMoneyAndDiamond) / 2;
                            this._diamondImage.x = Math.round(this._moneyText.x - this._diamondImage.width / 2 - this._config.spaceBetweenMoneyAndDiamond)
                        } else {
                            this._moneyText.x = (this._config.bounds.width - this.textWidth) / 2;
                            if (this._config.centerAlignOnlyMoney && !this._config.isShowingCredits) this._moneyText.x += w.currency / 2
                        }
                        ...
                        if (this._centsText.visible) {
                            ...
                            this._centsText.y = this._moneyText.y + moneyFontProps.ascent - centsFontProps.ascent;
                            this._suffix.x = this._centsText.x + w.decimalText;
                            this._suffix.y = this._centsText.y + centsFontProps.ascent - suffixFontProps.ascent
                        }
                        if (this.isCurrencyVisible) {
                            if (this._centsText.visible) this._currencyText.x = this._centsText.x + w.decimal;
                            else this._currencyText.x = this._moneyText.x + w.integer;
                            this._currencyText.y = this._moneyText.style.strokeThickness / 2 - this._currencyText.style.strokeThickness / 2 + this._moneyText.y + moneyFontProps.ascent - currencyFontProps.ascent;
                            this._suffix.x = this._currencyText.x + w.currency;
                            this._suffix.y = this._currencyText.y + currencyFontProps.ascent - suffixFontProps.ascent
                        }
                    };
                    ...
                    MoneyText.prototype.calculateWidths = function() {
                        ...
                        if (isDiamondVisible) currencyWidth = this._diamondImage.width;
                        else if (isCurrencyVisible) currencyWidth = this._currencyText.context.measureText(this._currencyText.text).width;
                    ...
                    MoneyText.prototype.fitToBounds = function() {
                        ...
                        var currencyCompensation = 0;
                        if (this._config.centerAlignOnlyMoney && "center" == this._config.align) currencyCompensation = this._config.diamond ? this._diamondImage.width + this._config.spaceBetweenMoneyAndDiamond : this._currencyText.context.measureText(this._currencyText.text).width;
                        ...
                        while (this.textWidth > this._config.bounds.width - currencyCompensation && moneyFontSize > this._config.minFontSize) {
                            ...
                            if (decimalStrokeRation) this._centsText.style.strokeThickness = centsFontSize / decimalStrokeRation;
                            this._moneyText.style = this._moneyText.style;
                            this._decimalSymbolText.style = this._decimalSymbolText.style;
                            this._centsText.style = this._centsText.style;
                            this.calculateFontProperty();
                            if (this._config.diamond && !this._config.keepDiamondSize) this.resizeDiamond();
                    ...
                    MoneyText = __decorate([log.decorator], MoneyText);
                    return MoneyText
                }(PIXI.Container);
                widgets.MoneyText = MoneyText;
                var MoneyTextConfig = function(_super) {
                    __extends(MoneyTextConfig, _super);
                    ...
                    MoneyTextConfig.prototype.serialize = function(obj) {
                        ...
                        if (void 0 == this.centsFontSize) this.centsFontSize = this.moneyFontSize;
                        if (void 0 == this.currencyFontSize) this.currencyFontSize = this.moneyFontSize;
                        if (void 0 == this.suffixFontSize) this.suffixFontSize = this.moneyFontSize
                    };
                    Object.defineProperty(MoneyTextConfig.prototype, "moneyString", {
                        get: function() {
                            var str = "";
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            var widgets;
            ! function(widgets) {
                var RollingBitmapNumberView = function(_super) {
                    ...
                    function RollingBitmapNumberView(config) {
                        ...
                        if (!_this._config.separatorSize) _this._config.separatorSize = 8;
                        if (void 0 === _this._config.topPadding) _this._config.topPadding = 0;
                        if (void 0 === _this._config.denomination) _this._config.denomination = 1;
                        if (void 0 === _this._config.horizontalSpacing) _this._config.horizontalSpacing = 0;
                    ...
                    RollingBitmapNumberView.prototype.isAnimating = function() {
                        ...
                        for (var i = 0; i < len; i++)
                            if (this._digitTweens[i]) return true;
                        if (this._failSafeTween) return true;
                        return false
                    };
                    ...
                    RollingBitmapNumberView.prototype.killTweens = function() {
                        var len = this._digitTweens.length;
                        for (var i = 0; i < len; i++) {
                            if (this._digitTweens[i]) this._digitTweens[i].kill();
                            this._digitTweens[i] = null
                        }
                        this.killFailSafeTween()
                    };
                    ...
                    RollingBitmapNumberView.prototype.setBounds = function(value) {
                        if (this._failSafeTween) this._finalValue = this._dummyObject.finalValue;
                        this._config.bounds = {
                            width: value.width,
                            height: value.height
                        };
                    ...
                    RollingBitmapNumberView.prototype.setValue = function(value, animating, time) {
                        ...
                        if (this._config.isDiamondPlay) value = Math.floor(value / 100);
                        else if (!this._config.currency) value = Math.floor(value / this._config.denomination);
                        else if (0 === this._config.numberOfCents) value = Math.floor(value / 100);
                        this._finalValue = value;
                        this._totalTime = time;
                        if (animating) {
                            this._delta = this._currValue - value;
                            if (0 === this._delta) return;
                            this.killFailSafeTween();
                            ...
                            if (anim) {
                                if (prevDir !== this._direction) this._oldDirection = prevDir
                            } else this.animateDigit(0)
                        } else {
                            var anim = this.isAnimating();
                            if (anim) {
                            ...
                            } else this.setFinalValue()
                        }
                    };
                    RollingBitmapNumberView.prototype.complete = function() {
                        if (this.isAnimating) TweenMax.to(this, .3, {
                            alpha: 0,
                            ease: Linear.easeNone,
                            onComplete: this.onFadeOutComplete.bind(this)
                        })
                    ...
                    RollingBitmapNumberView.prototype.createMask = function() {
                        if (null == this._storedMask) {
                            this._storedMask = new PIXI.Graphics;
                            this.addChild(this._storedMask);
                            if (!this._config.debug) this.mask = this._storedMask
                        }
                        this._storedMask.clear();
                        this._storedMask.beginFill(16711680, .5);
                    ...
                    RollingBitmapNumberView.prototype.animateDigit = function(index) {
                        if (index === this._digits.length) return;
                        if (this._digitTweens[index]) this._digitTweens[index].totalTime(this._digitTweens[index].totalDuration());
                        if (this._timePerCent < .04 || 1 === this._direction) {
                            this._dummyObject.value = this._currValue;
                            this._dummyObject.finalValue = this._finalValue;
                            this._failSafeTween = TweenMax.to(this._dummyObject, this._totalTime, {
                                value: this._finalValue,
                                ease: Linear.easeNone,
                                roundProps: ["value"],
                                onUpdate: this.onFailSafeTweenUpdate,
                                onUpdateScope: this,
                        ...
                        if (this._direction === -1 && 9 === currDigit || 1 === this._direction && 0 === currDigit) this.animateDigit(index + 1);
                        this._digitTweens[index] = TweenMax.to(digitSprite, this._timePerCent, {
                    ...
                    RollingBitmapNumberView.prototype.killFailSafeTween = function() {
                    ...
                    RollingBitmapNumberView.prototype.setFinalValue = function() {
                        ...
                        if (value > Math.pow(10, len) - 1) value %= Math.pow(10, len);
                        ...
                        for (var i = len - 1; i >= 0; i--) {
                            ...
                            if (i >= strLen) {
                                ...
                                if (!this._config.currency || i > this._config.numberOfCents) this._digits[i].visible = false
                            } else this._digits[i].children[0].text = strValue.charAt(strLen - 1 - i)
                        }
                        this.alpha = 1
                    };
                    RollingBitmapNumberView.prototype.onCentAnimationComplete = function(index) {
                        ...
                        if (0 === index) {
                            ...
                            if (1 === this._oldDirection) {
                                var limit = this._config.currency ? this._config.numberofCents + 1 : 1;
                                for (var i = this._digits.length - 1; i >= limit; i--)
                                    if (!this._digits[i].visible) continue
                            }
                            this._oldDirection = this._direction;
                            if (this._currValue !== this._finalValue) this.animateDigit(0)
                        }
                    };
                    ...
                    RollingBitmapNumberView.prototype.createNumbers = function() {
                        ...
                        for (var i = 0; i < digitsLength; i++) this.removeChild(this._digits[i]);
                        this._digits.length = 0;
                        if (null != this._dotTextField) {
                            this.removeChild(this._dotTextField);
                            this._dotTextField = null
                        }
                        if (this._config.currency && 0 != this._config.numberOfCents) this._dotTextField = new PIXI.extras.BitmapText(".", this._config.style);
                        ...
                        var dotSymbolWidth = null != this._dotTextField ? this._dotTextField.textWidth + this._config.horizontalSpacing : 0;
                        ...
                        for (var i = 0; i < properCountOfNumbers; i++) {
                            ...
                            for (var j = 0; j < 2; j++) {
                                ...
                                cont.addChild(txt);
                                if (1 === j) txt.position.y = this._config.bounds.height
                            }
                            if (sepCounter % 3 === 0 && 0 != i && this._config.currency) sepCount++;
                        ...
                        if (this._dotTextField) {
                            ...
                            for (var i = 0; i < this._config.numberOfCents; i++) {
                                ...
                                cont.position.x = startX + properCountOfNumbers * singleDigitWidth + i * singleDigitWidth + dotSymbolWidth + sepCount * this._config.separatorSize;
                                this.addChild(cont);
                                this._digits.unshift(cont);
                                cont.position.x = Math.round(cont.position.x)
                            }
                ...
                widgets.RollingBitmapNumberView = RollingBitmapNumberView
            }(widgets = library.widgets || (library.widgets = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
...
! function(com) {
    ...
    ! function(egt) {
        ...
        ! function(library) {
            var widgets;
            ! function(widgets) {
                var RollingNumberView = function(_super) {
                    ...
                    RollingNumberView.prototype.destroy = function(destroyChildren) {
                        _super.prototype.destroy.call(this, destroyChildren);
                        TweenMax.killTweensOf(this);
                        this.killTweens()
                    };
                    RollingNumberView.prototype.createMask = function() {
                        if (null != this._storedMask) this._storedMask.destroy(true);
                        this._storedMask = new PIXI.Graphics;
                        this._storedMask.beginFill(16711680, .5);
                        this._storedMask.drawRect(0, 0, this._config.bounds.width, this._config.bounds.height);
                        this._storedMask.endFill();
                    ...
                    RollingNumberView.prototype.killFailSafeTween = function() {
                        if (this._failSafeTween) {
                            this._failSafeTween.kill();
                            this._failSafeTween = null
                        }
                    ...
                    RollingNumberView.prototype.createNumbers = function() {
                        ...
                        for (var i = 0; i < digitsLength; i++) {
                            ...
                            this._digits[i].destroy(true)
                        }
                        this._digits.length = 0;
                        if (null != this._dotTextField) {
                            this.removeChild(this._dotTextField);
                            this._dotTextField.destroy(true);
                            this._dotTextField = null
                        }
                        this._config.style = {
                            align: "left",
                            fill: this._config.color ? this._config.color : 16777215,
                        ...
                        if (this._config.currency && 0 != this._config.numberOfCents) this._dotTextField = new PIXI.Text(".", this._config.style);
                        ...
                        var dotSymbolWidth = null != this._dotTextField ? this._dotTextField.width + this._config.horizontalSpacing : 0;
                        textField.destroy(true);
                        var properCountOfNumbers = count - (this._config.currency ? this._config.numberOfCents : 0);
                        var numberOfSeparators = Math.floor((properCountOfNumbers - 1) / 3);
                        var totalSeparatorsWidth = this._config.currency ? numberOfSeparators * this._config.separatorSize : 0;
                        var calculatedWidth = count * singleDigitWidth + (totalSeparatorsWidth - this._config.horizontalSpacing) + dotSymbolWidth;
                ...
                widgets.RollingNumberView = RollingNumberView
            }(widgets = library.widgets || (library.widgets = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(widgets) {
                var ScrollView = function(_super) {
                    ...
                    function ScrollView() {
                        ...
                        _this.on(library.Device.resolveEvent("mousedown"), _this.onMouseDown, _this);
                        _this.on(library.Device.resolveEvent("mousemove"), _this.onMouseMove, _this);
                        _this.on(library.Device.resolveEvent("mouseup"), _this.onMouseUp, _this);
                        _this.interactive = true;
                    ...
                    Object.defineProperty(ScrollView.prototype, "contentView", {
                        ...
                        set: function(view) {
                            if (this._contentView != view) {
                                if (null != this._contentView) this.removeChild(this._contentView);
                                this._contentView = view;
                                if (null != this._contentView) this.addChild(this._contentView)
                            }
                        },
                        enumerable: true,
                        configurable: true
                    ...
                    ScrollView.prototype.dispose = function() {
                        ...
                        this.off(library.Device.resolveEvent("mousedown"), this.onMouseDown, this);
                        this.off(library.Device.resolveEvent("mousemove"), this.onMouseMove, this);
                        this.off(library.Device.resolveEvent("mouseup"), this.onMouseUp, this);
                        PIXI.ticker.shared.remove(this.animateScroll, this)
                    };
                    ScrollView.prototype.createMask = function(width, height) {
                        if (null == this._maskSize) this._maskSize = new PIXI.Point;
                        this._maskSize.set(width, height);
                        var mask;
                        if (this.mask instanceof PIXI.Graphics) mask = this.mask;
                        else mask = new PIXI.Graphics;
                        mask.clear();
                    ...
                    ScrollView.prototype.animateScroll = function() {
                        ...
                        if (!this._touchDown && this._contentView) {
                            ...
                            if (y > 0) {
                                ...
                                bouncing = (this._maskSize.y - this._contentView.height - y) * ScrollView.BOUNCING_SPRINGESS;
                                this._scrollSpeed *= ScrollView.BOUNCING_DECAY
                            }
                    ...
                    ScrollView.prototype.onMouseDown = function(event) {
                        if (!this._contentView || this._contentView.height <= this._maskSize.y) return;
                        this._scrollSpeed = 0;
                    ...
                    ScrollView.prototype.onMouseMove = function(event) {
                        if (this._touchDown) {
                            ...
                            if (y > 0 || y + this._contentView.height < this._maskSize.y) decay = ScrollView.DRAG_DECAY;
                    ...
                    ScrollView.DECAY = .97;
                    ScrollView.BOUNCING_DECAY = .8;
                    ScrollView.SPEED_SPRINGNESS = .8;
                    ScrollView.BOUNCING_SPRINGESS = .15;
                    ScrollView.DRAG_DECAY = .4;
                    return ScrollView
                }(PIXI.Container);
                widgets.ScrollView = ScrollView
            }(widgets = library.widgets || (library.widgets = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(widgets) {
                var StateButton = function(_super) {
                    ...
                    StateButton.prototype.state = function(state) {
                        if (void 0 == state) return this._texturesState;
                        this._texturesState = state;
                        this.textures = this._states[state];
                        this.setImageForState(widgets.Button.STATE_UP)
                    };
                    return StateButton
                }(widgets.Button);
                widgets.StateButton = StateButton
            }(widgets = library.widgets || (library.widgets = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
            ...
            ! function(widgets) {
                var Text = function(_super) {
                    ...
                    Object.defineProperty(Text.prototype, "style", {
                        ...
                        set: function(value) {
                            if (void 0 == value.fontSize) value.fontSize = this._originalFontSize;
                    ...
                    Text.prototype.fitToBounds = function() {
                        ...
                        while (this._text.width > this._config.bounds.width && fontSize > this._config.minFontSize) {
                            fontSize--;
                    ...
                    Text.prototype.drawDebugRect = function() {
                        ...
                        if (this._config.debug) {
                            this._rect = new PIXI.Graphics;
                            this._rect.beginFill(16711680, .3);
                            this._rect.drawRect(0, 0, this._config.bounds.width, this._config.bounds.height);
                            this._rect.endFill();
                            this.addChild(this._rect)
                        }
                ...
                widgets.TextConfig = TextConfig
            }(widgets = library.widgets || (library.widgets = {}))
        }(library = egt.library || (egt.library = {}))
    }(egt = com.egt || (com.egt = {}))
}(com || (com = {}));
var DefaultBoxGenerator = com.egt.library.widgets.DefaultBoxGenerator;
var com;
! function(com) {
    var egt;
    ! function(egt) {
            ...
            ! function(widgets) {
                var TextInput = function(_super) {
                    ...
                    function TextInput(styles) {
                        var _this = _super.call(this) || this;
                        _this._substituteText = true;
                        _this._box_cache = {};
                        _this._previous = {};
                        _this._dom_added = false;
                        _this._dom_visible = true;
                        _this._placeholder = "";
                        _this._placeholderColor = 11119017;
                        ...
                        _this._input_style = __assign({}, defaultInputStyle, styles.input);
                        if (styles.box) _this._box_generator = "function" === typeof styles.box ? styles.box : widgets.DefaultBoxGenerator(styles.box);
                        else _this._box_generator = null;
                    ...
                    Object.defineProperty(TextInput.prototype, "placeholder", {
                        ...
                        set: function(text) {
                            ...
                            } else this._dom_input.placeholder = text
                        },
                        enumerable: true,
                        configurable: true
                    });
                    ...
                    Object.defineProperty(TextInput.prototype, "htmlInput", {
                        get: function() {
                    ...
                    TextInput.prototype.setInputStyle = function(key, value) {
                        ...
                        if (this._substituted && ("fontFamily" === key || "fontSize" === key)) this._updateFontMetrics();
                        if (this._last_renderer) this._update()
                    };
                    TextInput.prototype.dispose = function(options) {
                        this._destroyBoxCache();
                        _super.prototype.destroy.call(this, options)
                    };
                    TextInput.prototype._createDOMInput = function() {
                        if (this._multiline) {
                        ...
                        for (var key in this._input_style) this._dom_input.style[key] = this._input_style[key]
                    };
                    TextInput.prototype._addListeners = function() {
                    ...
                    TextInput.prototype._onInputKeyDown = function(e) {
                        this.emit("keydown", e.keyCode)
                    };
                    TextInput.prototype._onInputInput = function(e) {
                        if (this._substituted) this._updateSubstitution();
                        this.emit("input", this.text, this.id)
                    };
                    TextInput.prototype._onInputKeyUp = function(e) {
                    ...
                    TextInput.prototype._onAdded = function() {
                        document.body.appendChild(this._dom_input);
                        this._dom_input.style.display = "none";
                        this._dom_added = true
                    };
                    TextInput.prototype._onRemoved = function() {
                    ...
                    TextInput.prototype.renderWebGL = function(renderer) {
                        _super.prototype.renderWebGL.call(this, renderer);
                        this._renderInternal(renderer)
                    };
                    TextInput.prototype.renderCanvas = function(renderer) {
                    ...
                    TextInput.prototype._updateBox = function() {
                    ...
                    TextInput.prototype._updateSubstitution = function() {
                        if ("FOCUSED" === this.state) {
                            this._dom_visible = true;
                            this._surrogate.visible = 0 === this.text.length
                        } else {
                            this._dom_visible = false;
                    ...
                    TextInput.prototype._needsNewBoxCache = function() {
                    ...
                    TextInput.prototype._deriveSurrogateStyle = function() {
                        ...
                        for (var key in this._input_style) switch (key) {
                            case "color":
                        ...
                        if (0 === this._dom_input.value.length) style.fill = this._placeholderColor;
                        return style
                    };
                    TextInput.prototype._deriveSurrogatePadding = function() {
                        if (this._input_style.padding && this._input_style.padding.length > 0) {
                            ...
                            } else if (4 == components.length) return components.map(function(component) {
                    ...
                    TextInput.prototype._buildBoxCache = function() {
                        this._destroyBoxCache();
                        var states = ["DEFAULT", "FOCUSED", "DISABLED"];
                        var input_bounds = this._getDOMInputBounds();
                        for (var i in states) this._box_cache[states[i]] = this._box_generator(input_bounds.width, input_bounds.height, states[i]);
                        this._previous.input_bounds = input_bounds
                    };
                    TextInput.prototype._destroyBoxCache = function() {
                        if (this._box) {
                    ...
                    TextInput.prototype._setDOMInputVisible = function(visible) {
                    ...
                    TextInput.prototype._getDOMInputBounds = function() {
