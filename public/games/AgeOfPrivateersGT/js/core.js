...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/AgeOfPrivateersGT/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/AgeOfPrivateersGT/source/LOADER/progress'+i+'.png');
