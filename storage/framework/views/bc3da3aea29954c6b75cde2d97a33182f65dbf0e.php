...
document.location.href='../../../';	
	...
	return 4;
		...
		document.location.href=document.location.href+'/?game=keno&hash=&lang=en&protokol=wss&server=&port=&socket=&exit=&balanceInCash=1&m=&w=w1&curr=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>';	
		}else{
...
</html><?php /**PATH C:\OSPanel\domains\rustam\resources\views/frontend/games/list/BingoAM.blade.php ENDPATH**/ ?>