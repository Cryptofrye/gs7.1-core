...
namespace VanguardLTE\Games\AgeOfEgyptPTM
{
    class SlotSettings
    {
        ...
        public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState)
        {
            ...
            {
                $_obf_0D09321428053235180C062C0D08240E3E23031A161222 = $this->slotId . ' BG';
            }
        ...
        public function EggBonus($bet, $eggBonusNum)
        {
            ...
            $_obf_0D091E0A01271E061F232C0722302E18223B1540232A11 = [
                5, 
                5, 
                5, 
                5, 
            ...
            for( $j = 0; $j < 1500; $j++ ) 
            {
                ...
                $totalWin = 0;
                shuffle($_obf_0D091E0A01271E061F232C0722302E18223B1540232A11);
                for( $i = 0; $i < 6; $i++ ) 
                {
                    $curValues[$i] = $_obf_0D091E0A01271E061F232C0722302E18223B1540232A11[$i];
                    if( $i < $eggBonusNum ) 
                    {
                        $totalWin += ($_obf_0D091E0A01271E061F232C0722302E18223B1540232A11[$i] * $bet);
                    }
                }
                if( $totalWin <= $bank ) 
                {
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            {
                $_obf_0D2E231302321E2F343D3B3E320D03190C0A0923342F01 = rand(3, 5);
                ...
                $_obf_0D0302162F371B3D052D25022B15221416050237371B11 = rand(0, 19);
                for( $i = 0; $i < count($_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601); $i++ ) 
                {
                    if( $i < $_obf_0D2E231302321E2F343D3B3E320D03190C0A0923342F01 ) 
                    {
                        if( $randomBonus[0] == '9' ) 
                        {
                            $_obf_0D1F1D041B280532291A2C2B223C14135C2427303D0811[$_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]] = $this->PutBonusToLine($this->{'reelStrip' . $_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]}, $linesId[$_obf_0D0302162F371B3D052D25022B15221416050237371B11][$i]);
                        }
                        else
                        {
                            $_obf_0D1F1D041B280532291A2C2B223C14135C2427303D0811[$_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]}, $randomBonus);
                        }
                    }
                    else
                    {
