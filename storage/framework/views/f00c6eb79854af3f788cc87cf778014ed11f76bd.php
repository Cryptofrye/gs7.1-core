...
<?php $__env->startSection('content'); ?>
  ...
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo e(route('frontend.auth.login')); ?>"><span class="logo-lg"><b>Login</b> <small></small></span></a>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\rustam\resources\views/frontend/Default/auth/login.blade.php ENDPATH**/ ?>