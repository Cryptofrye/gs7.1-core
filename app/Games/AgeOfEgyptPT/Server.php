        ...
        {/*
            ...
            if( isset($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['spinType']) ) 
            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['spinType'] == 'regular' ) 
                {
                    ...
                    $bonusMpl = 1;
                    $slotSettings->SetGameData('AgeOfEgyptPTBonusWin', 0);
                    $slotSettings->SetGameData('AgeOfEgyptPTFreeGames', 0);
                    $slotSettings->SetGameData('AgeOfEgyptPTCurrentFreeGame', 0);
                    $slotSettings->SetGameData('AgeOfEgyptPTTotalWin', 0);
                    $slotSettings->SetGameData('AgeOfEgyptPTFreeBalance', 0);
                    $slotSettings->SetGameData('AgeOfEgyptPTFreeStartWin', 0);
                    $chosenTree = 0;
                    $startStick = 0;
                    $treeStep = [
                        -1, 
                    ...
                    $slotSettings->SetGameData('AgeOfEgyptPTChosenTree', $chosenTree);
                    $slotSettings->SetGameData('AgeOfEgyptPTstartStick', $startStick);
                    $slotSettings->SetGameData('AgeOfEgyptPTtreeStep', $treeStep);
                    $slotSettings->SetGameData('AgeOfEgyptPTlastWins', $lastWins);
                }
                else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['spinType'] == 'free' ) 
                {
                    ...
                    $slotSettings->SetGameData('AgeOfEgyptPTCurrentFreeGame', $slotSettings->GetGameData('AgeOfEgyptPTCurrentFreeGame') + 1);
                ...
                $slotSettings->SetGameData('AgeOfEgyptPTAllBet', $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['bet']);
                $slotSettings->SetGameData('AgeOfEgyptPTBetLine', $betLine);
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    $totalWin = 0;
                    $lineWins = [];
                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                    {
                                        ...
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfEgyptPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfEgyptPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfEgyptPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfEgyptPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[4], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfEgyptPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    $slotSettings->SetGameData('AgeOfEgyptPTBonusWin', $slotSettings->GetGameData('AgeOfEgyptPTBonusWin') + $totalWin);
                    $slotSettings->SetGameData('AgeOfEgyptPTTotalWin', $totalWin);
                }
                else
                {
                    $slotSettings->SetGameData('AgeOfEgyptPTTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('AgeOfEgyptPTFreeGames') > 0 ) 
                    {
                        $slotSettings->SetGameData('AgeOfEgyptPTFreeGames', $slotSettings->GetGameData('AgeOfEgyptPTFreeGames') + $slotSettings->slotFreeCount);
                    }
                    else
                    {
                        $slotSettings->SetGameData('AgeOfEgyptPTFreeStartWin', $totalWin);
                        $slotSettings->SetGameData('AgeOfEgyptPTBonusWin', 0);
                        $slotSettings->SetGameData('AgeOfEgyptPTFreeGames', $slotSettings->slotFreeCount);
                    }
                }
                ...
                if( $_obf_0D211F2E30212A2A2B081A2303152D4036262E1D244001 ) 
                {
                    ...
                    $slotSettings->SetGameData('AgeOfEgyptPTWinValues', $_obf_0D1B2B063D1C283C0136243D2716223D30162D05260732['curValues']);
                    $slotSettings->SetGameData('AgeOfEgyptPTPickedCount', 0);
                    $slotSettings->SetGameData('AgeOfEgyptPTPickedCountArr', []);
                    $slotSettings->SetGameData('AgeOfEgyptPTeggBonusNum', $eggBonusNum);
                }
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{' . $_obf_0D0714245B2417292334031F051A36231C2F0802371622 . '"allbet":' . $slotSettings->GetGameData('AgeOfEgyptPTAllBet') . ',"betLine":' . $slotSettings->GetGameData('AgeOfEgyptPTBetLine') . ',"linesArr":[' . implode(',', $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('AgeOfEgyptPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AgeOfEgyptPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('AgeOfEgyptPTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('AgeOfEgyptPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                $slotSettings->SetGameData('AgeOfEgyptPTLastResponse', $response);
            ...
            {
                case '47552':
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['pickNum'] >= 0 && $slotSettings->GetGameData('AgeOfEgyptPTPickedCount') < $slotSettings->GetGameData('AgeOfEgyptPTeggBonusNum') ) 
                    {
                        $_obf_0D15343E02090311371C0D341B380D082C1F1E1F032101 = json_decode($slotSettings->GetGameData('AgeOfEgyptPTLastResponse'));
                        $values = $slotSettings->GetGameData('AgeOfEgyptPTWinValues');
                        $pick = $slotSettings->GetGameData('AgeOfEgyptPTPickedCount');
                        $_obf_0D19040F1517090137280D011A253B1C24062916302F22 = $slotSettings->GetGameData('AgeOfEgyptPTPickedCountArr');
                        $_obf_0D0C361D2E35362209025C2317232809271D34270D3232 = $values[$pick] * $slotSettings->GetGameData('AgeOfEgyptPTBetLine');
                        ...
                        $slotSettings->SetGameData('AgeOfEgyptPTPickedCount', $pick);
                        $slotSettings->SetGameData('AgeOfEgyptPTPickedCountArr', $_obf_0D19040F1517090137280D011A253B1C24062916302F22);
                        ...
                        $slotSettings->SetGameData('AgeOfEgyptPTLastResponse', json_encode($_obf_0D15343E02090311371C0D341B380D082C1F1E1F032101));
                ...
                case '40036':
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $slotSettings->SetGameData('AgeOfEgyptPTLastResponse', json_encode($lastEvent));
                        $slotSettings->SetGameData('AgeOfEgyptPTWinValues', $lastEvent->serverResponse->winValues);
                        $slotSettings->SetGameData('AgeOfEgyptPTPickedCount', $lastEvent->serverResponse->PickedCount);
                        $slotSettings->SetGameData('AgeOfEgyptPTPickedCountArr', $lastEvent->serverResponse->PickedCountArr);
                        $slotSettings->SetGameData('AgeOfEgyptPTEggNum', $lastEvent->serverResponse->eggBonusNum);
                        $slotSettings->SetGameData('AgeOfEgyptPTEeggBonusNum', $lastEvent->serverResponse->eggBonusNum);
                        if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') > 0 ) 
                        {
                            $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'agoeg');
                        }
                        if( $lastEvent->responseType == 'egg_bonus' && $slotSettings->GetGameData('AgeOfEgyptPTPickedCount') < $slotSettings->GetGameData('AgeOfEgyptPTEeggBonusNum') ) 
                        {
                            $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'agoeg');
                        }
                        $slotSettings->SetGameData('AgeOfEgyptPTresponseType', $lastEvent->responseType);
                    }
                ...
                case '40030':
                    ...
                    {
                        if( $slotSettings->GetGameData('AgeOfEgyptPTresponseType') == 'egg_bonus' ) 
                        {
                            $values = $slotSettings->GetGameData('AgeOfEgyptPTWinValues');
                            $pick = $slotSettings->GetGameData('AgeOfEgyptPTPickedCount');
                            $_obf_0D19040F1517090137280D011A253B1C24062916302F22 = $slotSettings->GetGameData('AgeOfEgyptPTPickedCountArr');
