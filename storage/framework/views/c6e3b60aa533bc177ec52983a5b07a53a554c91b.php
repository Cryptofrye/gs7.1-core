<header class="main-header">
    ...
    <a class="logo" href="<?php echo e(url('/')); ?>">
        ...
        <span class="logo-lg"><b>Office</b> <small></small></span>
    </a>
...
<!-- Left side column. contains the logo and sidebar --><?php /**PATH C:\OSPanel\domains\rustam\resources\views/backend/partials/navbar.blade.php ENDPATH**/ ?>